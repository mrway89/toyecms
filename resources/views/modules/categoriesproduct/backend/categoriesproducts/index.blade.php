                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("categoriesproduct::text.name")
                            </th>
                            <th>
                                @lang("categoriesproduct::text.slug")
                            </th>
                            <th>
                                @lang("categoriesproduct::text.updated_at")
                            </th>
                            <th>
                                @lang("categoriesproduct::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("categoriesproduct::text.action")
                            </th>
                        </tr>
                    </thead>
