                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("productexcellence::text.name")
                            </th>
                            <th>
                                @lang("productexcellence::text.slug")
                            </th>
                            <th>
                                @lang("productexcellence::text.updated_at")
                            </th>
                            <th>
                                @lang("productexcellence::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("productexcellence::text.action")
                            </th>
                        </tr>
                    </thead>
