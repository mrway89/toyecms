                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("aboutdescthree::text.name")
                            </th>
                            <th>
                                @lang("aboutdescthree::text.slug")
                            </th>
                            <th>
                                @lang("aboutdescthree::text.updated_at")
                            </th>
                            <th>
                                @lang("aboutdescthree::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("aboutdescthree::text.action")
                            </th>
                        </tr>
                    </thead>
