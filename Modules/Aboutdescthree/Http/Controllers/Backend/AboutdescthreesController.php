...
namespace Modules\Aboutdescthree\Http\Controllers\Backend;
...
class AboutdescthreesController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'Aboutdescthrees';

        // module name
        $this->module_name = 'aboutdescthrees';

        // directory path of the module
        $this->module_path = 'aboutdescthree::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\Aboutdescthree\Models\Aboutdescthree";
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('image2')){
            ...
            $$module_name_singular->featured_image2 = 'public/storage/media/'.$filename;
        ...
        if($request->file('image3')){
            ...
            $$module_name_singular->featured_image3 = 'public/storage/media/'.$filename;
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('backend.aboutdescthrees.show', $$module_name_singular->id);
    }
