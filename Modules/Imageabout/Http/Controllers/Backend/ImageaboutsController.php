...
namespace Modules\Imageabout\Http\Controllers\Backend;
...
class ImageaboutsController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'Imageabouts';

        // module name
        $this->module_name = 'imageabouts';

        // directory path of the module
        $this->module_path = 'imageabout::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\Imageabout\Models\Imageabout";
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('backend.imageabouts.show', $$module_name_singular->id);
    }
