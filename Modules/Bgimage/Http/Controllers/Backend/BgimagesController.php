...
namespace Modules\Bgimage\Http\Controllers\Backend;
...
use Modules\Bgimage\Events\BgimagesCreated;
use Modules\Bgimage\Events\BgimagesUpdated;
use Modules\Bgimage\Http\Requests\Backend\BgimageRequest;
...
class BgimagesController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'Bgimages';

        // module name
        $this->module_name = 'bgimages';

        // directory path of the module
        $this->module_path = 'bgimage::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\Bgimage\Models\Bgimage";
    }
    ...
    public function index()
    {
        ...
        return view(
            "bgimage::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id', 'name', 'description', 'created_at','order');
    ...
    public function create()
    {
        ...
        return view(
            "bgimage::backend.$module_name.create",
     ...
     * @return Response
     */
    public function store(BgimageRequest $request)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        ...
        $module_action = 'Store';
        $cek    = $module_model::latest('order')->first();
       
            $cek    = $module_model::latest('order')->first();	
            if($cek){
                $num_id = $module_model::latest()->first()->order;
                $data['order'] = $num_id + 1;
            }
            else {
                $data['order'] = 1;
        ...
        $$module_name_singular = $module_model::create($data, $request->except('images'));
    ...
    public function show($id)
    {
       ...
       /* $activities = Activity::where('subject_type', '=', $module_model)
        ...
        return view(
            "bgimage::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "bgimage::backend.$module_name.edit",
            compact('module_title', 'module_path', 'module_name', 'module_icon', 'module_name_singular', 'module_action', "$module_name_singular")
        );
    }
     ...
     * @return Response
     */
    public function update(BgimageRequest $request, $id)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
    ...
    public function trashed()
    {
        ...
        return view(
            "bgimage::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
