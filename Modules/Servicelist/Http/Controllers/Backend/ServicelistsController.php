...
namespace Modules\Servicelist\Http\Controllers\Backend;
...
class ServicelistsController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'Servicelists';

        // module name
        $this->module_name = 'servicelists';

        // directory path of the module
        $this->module_path = 'servicelist::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\Servicelist\Models\Servicelist";
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('backend.servicelists.show', $$module_name_singular->id);
    }
