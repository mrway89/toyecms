...
namespace Modules\Homesolution\Http\Controllers\Backend;
...
class HomesolutionsController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'Homesolutions';

        // module name
        $this->module_name = 'homesolutions';

        // directory path of the module
        $this->module_path = 'homesolution::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\Homesolution\Models\Homesolution";
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('backend.homesolutions.show', $$module_name_singular->id);
    }
