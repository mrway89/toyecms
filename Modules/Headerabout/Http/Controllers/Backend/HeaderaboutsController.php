...
namespace Modules\Headerabout\Http\Controllers\Backend;
...
class HeaderaboutsController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'Headerabouts';

        // module name
        $this->module_name = 'headerabouts';

        // directory path of the module
        $this->module_path = 'headerabout::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\Headerabout\Models\Headerabout";
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('backend.headerabouts.show', $$module_name_singular->id);
    }
