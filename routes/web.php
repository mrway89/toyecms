...
//Route::get('/', 'App\Http\Controllers\Auth\AuthenticatedSessionController@create')->name('index');
...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::get('watertreatment', 'FrontendController@watertreatment')->name('water-treatment');
    Route::get('drinkable', 'FrontendController@drinkable')->name('drinkable-water-filtration');
    Route::get('blog', 'FrontendController@blog')->name('blog');
    Route::get('detail/{id}', 'FrontendController@detail')->name('detail');
    Route::get('peoductdetail/{id}', 'FrontendController@productdetail')->name('productdetail');
...
Route::group(['namespace' => 'App\Http\Controllers\Backend', 'prefix' => 'admin', 'as' => 'backend.', 'middleware' => ['auth', 'can:view_backend']], function () {
    ...
    */
    ...
    Route::get("$module_name/{id}/{ids}", ['as' => "$module_name.imgdel", 'uses' => "$controller_name@imgdel"]);
