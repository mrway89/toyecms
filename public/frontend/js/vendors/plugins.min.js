! function(t, e) {
	...
	C.fn = C.prototype = {
		...
		for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || b(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
			if (null != (t = arguments[a]))
				for (e in t) n = s[e], s !== (i = t[e]) && (c && i && (C.isPlainObject(i) || (o = Array.isArray(i))) ? (r = o ? (o = !1, n && Array.isArray(n) ? n : []) : n && C.isPlainObject(n) ? n : {}, s[e] = C.extend(c, r, i)) : void 0 !== i && (s[e] = i));
		return s
	}, C.extend({
		...
		makeArray: function(t, e) {
			var n = e || [];
			return null != t && (h(Object(t)) ? C.merge(n, "string" == typeof t ? [t] : t) : l.call(n, t)), n
		},
	...
	var f = function(n) {
		...
		var t, f, _, r, s, p, h, g, w, l, c, x, S, a, T, m, u, v, y, C = "sizzle" + 1 * new Date,
			b = n.document,
			E = 0,
			i = 0,
			k = st(),
		...
		try {
			O.apply(e = j.call(b.childNodes), b.childNodes), e[b.childNodes.length].nodeType
		} catch (n) {
			O = {
		...
		function rt(t, e, n, i) {
			...
			if (!i && ((e ? e.ownerDocument || e : b) !== S && x(e), e = e || S, T)) {
				if (11 !== h && (l = J.exec(t)))
					if (o = l[1]) {
						if (9 === h) {
					...
					if (1 !== h) d = e, u = t;
						...
						for ((a = e.getAttribute("id")) ? a = a.replace(nt, it) : e.setAttribute("id", a = C), r = (c = p(t)).length; r--;) c[r] = "#" + a + " " + vt(c[r]);
		...
		for (t in f = rt.support = {}, s = rt.isXML = function(t) {
				...
				return i !== S && 9 === i.nodeType && i.documentElement && (a = (S = i).documentElement, T = !s(S), b !== S && (n = S.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), f.attributes = lt(function(t) {
					...
					return a.appendChild(t).id = C, !S.getElementsByName || !S.getElementsByName(C).length
				...
				}, u = [], m = [], (f.qsa = Z.test(S.querySelectorAll)) && (lt(function(t) {
					...
					e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && m.push("name" + z + "*[*^$|!~]?="), 2 !== t.querySelectorAll(":enabled").length && m.push(":enabled", ":disabled"), a.appendChild(t).disabled = !0, 2 !== t.querySelectorAll(":disabled").length && m.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), m.push(",.*:")
				})), (f.matchesSelector = Z.test(v = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector)) && lt(function(t) {
					f.disconnectedMatch = v.call(t, "*"), v.call(t, "[s!='']:x"), u.push("!=", R)
				}), m = m.length && new RegExp(m.join("|")), u = u.length && new RegExp(u.join("|")), e = Z.test(a.compareDocumentPosition), y = e || Z.test(a.contains) ? function(t, e) {
					...
					return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !f.sortDetached && e.compareDocumentPosition(t) === n ? t === S || t.ownerDocument === b && y(b, t) ? -1 : e === S || e.ownerDocument === b && y(b, e) ? 1 : l ? N(l, t) - N(l, e) : 0 : 4 & n ? -1 : 1)
				} : function(t, e) {
					if (t === e) return c = !0, 0;
					var n, i = 0,
						o = t.parentNode,
				...
				if ((t.ownerDocument || t) !== S && x(t), e = e.replace(Q, "='$1']"), f.matchesSelector && T && !I[e + " "] && (!u || !u.test(e)) && (!m || !m.test(e))) try {
					var n = v.call(t, e);
				...
				preFilter: {
					...
					PSEUDO: function(t) {
						var e, n = !t[6] && t[2];
						return V.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && Y.test(n) && (e = p(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
					}
				},
				filter: {
					TAG: function(t) {
						...
						return 1 === g && 0 === m ? function(t) {
							...
							if (u) {
								...
								if (l = [y ? u.firstChild : u.lastChild], y && h) {
									for (f = (a = (i = (o = (r = (s = u)[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === E && i[1]) && i[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (f = a = 0) || l.pop();)
										if (1 === s.nodeType && ++f && s === t) {
											o[p] = [E, a, f];
											break
										}
								} else if (h && (f = a = (i = (o = (r = (s = t)[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === E && i[1]), !1 === f)
									for (;
										(s = ++a && s && s[c] || (f = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== d : 1 !== s.nodeType) || !++f || (h && ((o = (r = s[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] = [E, f]), s !== t)););
					...
					PSEUDO: function(t, r) {
						...
						return s[C] ? s(r) : 1 < s.length ? (e = [t, t, "", r], _.setFilters.hasOwnProperty(t.toLowerCase()) ? at(function(t, e) {
							for (var n, i = s(t, r), o = i.length; o--;) t[n = N(t, i[o])] = !(e[n] = i[o])
						}) : function(t) {
							return s(t, 0, e)
						}) : s
					}
				...
				pseudos: {
					...
					lang: at(function(n) {
						return X.test(n || "") || rt.error("unsupported lang: " + n), n = n.replace(et, d).toLowerCase(),
							function(t) {
								var e;
								do {
		...
		function wt(f, p, g, m, v, t) {
			return m && !m[C] && (m = wt(m)), v && !v[C] && (v = wt(v, t)), at(function(t, e, n, i) {
				var o, r, s, a = [],
					l = [],
					c = e.length,
					u = t || function(t, e, n) {
					...
					h = g ? v || (t ? f : c || m) ? [] : e : d;
				if (g && g(d, h, n, i), m)
					for (o = _t(h, l), m(o, [], n, i), r = o.length; r--;)(s = o[r]) && (h[l[r]] = !(d[l[r]] = s));
				if (t) {
					if (v || f) {
						if (v) {
		...
		return mt.prototype = _.filters = _.pseudos, _.setFilters = new mt, p = rt.tokenize = function(t, e) {
			...
			for (s = t, a = [], l = _.preFilter; s;) {
				for (r in n && !(i = B.exec(s)) || (i && (s = s.slice(i[0].length) || s), a.push(o = [])), n = !1, (i = U.exec(s)) && (n = i.shift(), o.push({
						value: n,
						type: i[0].replace(q, " ")
					}), s = s.slice(n.length)), _.filter) !(i = V[r].exec(s)) || l[r] && !(i = l[r](i)) || (n = i.shift(), o.push({
					value: n,
					type: r,
					matches: i
				}), s = s.slice(n.length));
			...
			var n, i = [],
				...
				r = I[t + " "];
			if (!r) {
				for (e || (e = p(t)), n = e.length; n--;)(r = xt(e[n]))[C] ? i.push(r) : o.push(r);
				(r = I(t, function(m, v) {
					function t(t, e, n, i, o) {
						var r, s, a, l = 0,
							...
							g = f.length;
						for (o && (w = e === S || e || o); c !== g && null != (r = f[c]); c++) {
							if (b && r) {
								for (s = 0, e || r.ownerDocument === S || (x(r), n = !T); a = m[s++];)
									if (a(r, e || S, n)) {
										i.push(r);
										break
									} o && (E = p)
						...
						if (l += c, y && c !== l) {
							...
							O.apply(i, d), o && !t && 0 < d.length && 1 < l + v.length && rt.uniqueSort(i)
						}
						return o && (E = p, w = h), u
					}
					var y = 0 < v.length,
			...
			if (n = n || [], 1 === u.length) {
				if (2 < (r = u[0] = u[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === e.nodeType && T && _.relative[r[1].type]) {
					if (!(e = (_.find.ID(s.matches[0].replace(et, d), e) || [])[0])) return n;
					c && (e = e.parentNode), t = t.slice(r.shift().value.length)
				}
				for (o = V.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !_.relative[a = s.type]);)
					if ((l = _.find[a]) && (i = l(s.matches[0].replace(et, d), tt.test(r[0].type) && gt(e.parentNode) || e))) {
						if (r.splice(o, 1), !(t = i.length && vt(r))) return O.apply(n, i), n;
						break
					}
			}
			return (c || h(t, u))(i, e, !T, n, !e || tt.test(t) && gt(e.parentNode) || e), n
		}, f.sortStable = C.split("").sort(D).join("") === C, f.detectDuplicates = !!c, x(), f.sortDetached = lt(function(t) {
	...
	C.filter = function(t, e, n) {
		...
		is: function(t) {
			return !!I(this, "string" == typeof t && E.test(t) ? C(t) : t || [], !1).length
		}
	});
	var D, P = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
	...
	C.fn.extend({
		...
		C.fn[i] = function(t, e) {
			...
			return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = C.filter(e, n)), 1 < this.length && (L[i] || C.uniqueSort(n), $.test(i) && n.reverse()), this.pushStack(n)
		}
	});
	var j = /[^\x20\t\r\n\f]+/g;
	...
	C.Callbacks = function(i) {
		i = "string" == typeof i ? function(t) {
			var n = {};
			return C.each(t.match(j) || [], function(t, e) {
				n[e] = !0
			}), n
		}(i) : C.extend({}, i);
				...
				add: function() {
					return s && (t && !o && (l = s.length - 1, a.push(t)), function n(t) {
						C.each(t, function(t, e) {
							b(e) ? i.unique && c.has(e) || s.push(e) : e && e.length && "string" !== w(e) && n(e)
						})
					}(arguments), t && !o && n()), this
				},
				remove: function() {
					return C.each(arguments, function(t, e) {
						for (var n; - 1 < (n = C.inArray(e, s, n));) s.splice(n, 1), n <= l && l--
					}), this
				},
				has: function(t) {
				...
				s = {
					...
					then: function(e, n, i) {
							...
							return function() {
								function t() {
									...
									if (!(o < l)) {
										...
										e = t && ("object" == typeof t || "function" == typeof t) && t.then, b(e) ? a ? e.call(t, c(l, r, N, a), c(l, r, M, a)) : (l++, e.call(t, c(l, r, N, a), c(l, r, M, a), c(l, r, N, r.notifyWith))) : (s !== N && (n = void 0, i = [t]), (a || r.resolveWith)(n, i))
									}
								}
								var n = this,
									i = arguments,
									e = a ? t : function() {
										try {
											...
											C.Deferred.exceptionHook && C.Deferred.exceptionHook(t, e.stackTrace), l <= o + 1 && (s !== M && (n = void 0, i = [t]), r.rejectWith(n, i))
										}
									};
						...
						return C.Deferred(function(t) {
							r[0][3].add(c(0, t, b(i) ? i : N, t.notifyWith)), r[1][3].add(c(0, t, b(e) ? e : N)), r[2][3].add(c(0, t, b(n) ? n : M))
						}).promise()
					},
					promise: function(t) {
		...
		when: function(t) {
			...
			var n = arguments.length,
				...
				r = a.call(arguments),
				s = C.Deferred();
			if (n <= 1 && (z(t, s.done(e(i)).resolve, s.reject, !n), "pending" === s.state() || b(r[i] && r[i].then))) return s.then();
	...
	function R() {
		T.removeEventListener("DOMContentLoaded", R), S.removeEventListener("load", R), C.ready()
	}
	...
	}), C.ready.then = F.then, "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? S.setTimeout(C.ready) : (T.addEventListener("DOMContentLoaded", R), S.addEventListener("load", R));
	...
	function vt(t, e, n, i, o) {
		for (var r, s, a, l, c, u, d = e.createDocumentFragment(), h = [], f = 0, p = t.length; f < p; f++)
			...
			for (s = s || d.appendChild(e.createElement("div")), a = (ct.exec(r) || ["", ""])[1].toLowerCase(), l = dt[a] || dt._default, s.innerHTML = l[1] + C.htmlPrefilter(r) + l[2], u = l[0]; u--;) s = s.lastChild;
			C.merge(h, s.childNodes), (s = d.firstChild).textContent = ""
		} else h.push(e.createTextNode(r));
		for (d.textContent = "", f = 0; r = h[f++];)
			if (i && -1 < C.inArray(r, i)) o && o.push(r);
			else if (c = C.contains(r.ownerDocument, r), s = ht(d.appendChild(r), "script"), c && ft(s), n)
			for (u = 0; r = s[u++];) ut.test(r.type || "") && n.push(r);
		return d
	}
	pt = T.createDocumentFragment().appendChild(T.createElement("div")), (gt = T.createElement("input")).setAttribute("type", "radio"), gt.setAttribute("checked", "checked"), gt.setAttribute("name", "t"), pt.appendChild(gt), y.checkClone = pt.cloneNode(!0).cloneNode(!0).lastChild.checked, pt.innerHTML = "<textarea>x</textarea>", y.noCloneChecked = !!pt.cloneNode(!0).lastChild.defaultValue;
	...
	C.event = {
		...
		add: function(e, t, n, i, o) {
			var r, s, a, l, c, u, d, h, f, p, g, m = V.get(e);
			if (m)
				for (n.handler && (n = (r = n).handler, o = r.selector), o && C.find.matchesSelector(yt, o), n.guid || (n.guid = C.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
						return void 0 !== C && C.event.triggered !== t.type ? C.event.dispatch.apply(e, arguments) : void 0
					}), c = (t = (t || "").match(j) || [""]).length; c--;) f = g = (a = wt.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f && (d = C.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, d = C.event.special[f] || {}, u = C.extend({
					type: f,
					origType: g,
					data: i,
					handler: n,
					...
					namespace: p.join(".")
				}, r), (h = l[f]) || ((h = l[f] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, p, s) || e.addEventListener && e.addEventListener(f, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, u) : h.push(u), C.event.global[f] = !0)
		},
		remove: function(t, e, n, i, o) {
			var r, s, a, l, c, u, d, h, f, p, g, m = V.hasData(t) && V.get(t);
			if (m && (l = m.events)) {
				for (c = (e = (e || "").match(j) || [""]).length; c--;)
					if (f = g = (a = wt.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
						for (d = C.event.special[f] || {}, h = l[f = (i ? d.delegateType : d.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = h.length; r--;) u = h[r], !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (h.splice(r, 1), u.selector && h.delegateCount--, d.remove && d.remove.call(t, u));
						s && !h.length && (d.teardown && !1 !== d.teardown.call(t, p, m.handle) || C.removeEvent(t, f, m.handle), delete l[f])
					} else
	...
	function Lt(t, e) {
		var n, i, o, r, s, a, l, c;
		if (1 === e.nodeType) {
			if (V.hasData(t) && (r = V.access(t), s = V.set(e, r), c = r.events))
	...
	function Ot(n, i, o, r) {
		...
		var t, e, s, a, l, c, u = 0,
			...
			f = i[0],
			p = b(f);
		if (p || 1 < d && "string" == typeof f && !y.checkClone && At.test(f)) return n.each(function(t) {
			var e = n.eq(t);
			p && (i[0] = f.call(this, t, e.html())), Ot(e, i, o, r)
		});
		if (d && (e = (t = vt(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === t.childNodes.length && (t = e), e || r)) {
			for (a = (s = C.map(ht(t, "script"), Pt)).length; u < d; u++) l = t, u !== h && (l = C.clone(l, !0, !0), a && C.merge(s, ht(l, "script"))), o.call(n[u], l, u);
			if (a)
				for (c = s[s.length - 1].ownerDocument, C.map(s, $t), u = 0; u < a; u++) l = s[u], ut.test(l.type || "") && !V.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(l.src) : _(l.textContent.replace(It, ""), c, l))
		}
		return n
	}

	function jt(t, e, n) {
		for (var i, o = e ? C.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || C.cleanData(ht(i)), i.parentNode && (n && C.contains(i.ownerDocument, i) && ft(ht(i, "script")), i.parentNode.removeChild(i));
		return t
	}
	C.extend({
		...
		clone: function(t, e, n) {
			...
			if (!(y.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || C.isXMLDoc(t)))
				for (s = ht(u), i = 0, o = (r = ht(t)).length; i < o; i++) a = r[i], l = s[i], void 0, "input" === (c = l.nodeName.toLowerCase()) && lt.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
			if (e)
				if (n)
					for (r = r || ht(t), s = s || ht(u), i = 0, o = r.length; i < o; i++) Lt(r[i], s[i]);
				else Lt(t, u);
		...
		html: function(t) {
			return W(this, function(t) {
				...
				if ("string" == typeof t && !kt.test(t) && !dt[(ct.exec(t) || ["", ""])[1].toLowerCase()]) {
					t = C.htmlPrefilter(t);
					try {
						for (; n < i; n++) 1 === (e = this[n] || {}).nodeType && (C.cleanData(ht(e, !1)), e.innerHTML = t);
						e = 0
					} catch (t) {}
				}
		...
		replaceWith: function() {
			...
			return Ot(this, arguments, function(t) {
				...
				C.inArray(this, n) < 0 && (C.cleanData(ht(this)), e && e.replaceChild(t, this))
			}, n)
		}
	}), C.each({
		appendTo: "append",
	...
	var Nt, Mt, zt, Ht, Ft, Rt, Wt, qt = new RegExp("^(" + et + ")(?!px)[a-z%]+$", "i"),
		Bt = function(t) {
	...
	function Qt() {
		if (Wt) {
			...
			Nt = "1%" !== t.top, Ft = 12 === Yt(t.marginLeft), Wt.style.right = "60%", Ht = 36 === Yt(t.right), Mt = 36 === Yt(t.width), Wt.style.position = "absolute", zt = 36 === Wt.offsetWidth || "absolute", yt.removeChild(Rt), Wt = null
		}
	}
	...
	function Xt(t, e, n) {
		...
		return (n = n || Bt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || C.contains(t.ownerDocument, t) || (s = C.style(t, e)), !y.pixelBoxStyles() && qt.test(s) && Ut.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
	}
	...
	Rt = T.createElement("div"), (Wt = T.createElement("div")).style && (Wt.style.backgroundClip = "content-box", Wt.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Wt.style.backgroundClip, C.extend(y, {
	...
	function re(t, e, n) {
		...
		return s = s && (y.boxSizingReliable() || o === t.style[e]), "auto" !== o && (parseFloat(o) || "inline" !== C.css(t, "display", !1, i)) || (o = t["offset" + e[0].toUpperCase() + e.slice(1)], s = !0), (o = parseFloat(o) || 0) + oe(t, e, n || (r ? "border" : "content"), s, i, o) + "px"
	}
	...
	C.extend({
		...
		style: function(t, e, n, i) {
			if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
				var o, r, s, a = Q(e),
					l = Gt.test(e),
					c = t.style;
				if (l || (e = ne(a)), s = C.cssHooks[e] || C.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : c[e];
		...
		css: function(t, e, n, i) {
			var o, r, s, a = Q(e);
			return Gt.test(e) || (e = ne(a)), (s = C.cssHooks[e] || C.cssHooks[a]) && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = Xt(t, e, i)), "normal" === o && e in Jt && (o = Jt[e]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
		}
	}), C.each(["height", "width"], function(t, a) {
		C.cssHooks[a] = {
			get: function(t, e, n) {
				if (e) return !Kt.test(C.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? re(t, a, n) : tt(t, Zt, function() {
					return re(t, a, n)
				})
			},
			set: function(t, e, n) {
				var i, o = Bt(t),
					...
					s = n && oe(t, a, n, r, o);
				return r && y.scrollboxSize() === o.position && (s -= Math.ceil(t["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(o[a]) - oe(t, a, "border", !1, o) - .5)), s && (i = nt.exec(e)) && "px" !== (i[3] || "px") && (t.style[a] = e, e = C.css(t, a)), ie(0, e, s)
			}
		}
	...
	var ae, le, ce, ue, de = /^(?:toggle|show|hide)$/,
		he = /queueHooks$/;

	function fe() {
		le && (!1 === T.hidden && S.requestAnimationFrame ? S.requestAnimationFrame(fe) : S.setTimeout(fe, C.fx.interval), C.fx.tick())
	}
	...
	function ve(r, t, e) {
		...
		for (function(t, e) {
				var n, i, o, r, s;
				for (n in t)
					if (o = e[i = Q(n)], r = t[n], Array.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (s = C.cssHooks[i]) && "expand" in s)
						for (n in r = s.expand(r), delete t[i], r) n in t || (t[n] = r[n], e[n] = o);
					else e[i] = o
			}(u, c.opts.specialEasing); i < o; i++)
			if (n = ve.prefilters[i].call(c, r, u, c.opts)) return b(n.stop) && (C._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
		return C.map(u, me, c), b(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), C.fx.timer(C.extend(l, {
			elem: r,
			anim: c,
			queue: c.opts.queue
		})), c
	...
	C.Animation = C.extend(ve, {
		...
		tweener: function(t, e) {
			for (var n, i = 0, o = (t = b(t) ? (e = t, ["*"]) : t.match(j)).length; i < o; i++) n = t[i], ve.tweeners[n] = ve.tweeners[n] || [], ve.tweeners[n].unshift(e)
		},
		prefilters: [function(t, e, n) {
			...
			for (i in n.queue || (null == (s = C._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
				...
				for (i in d && 1 === t.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = V.get(t, "display")), "none" === (u = C.css(t, "display")) && (c ? u = c : (at([t], !0), c = t.style.display || c, u = C.css(t, "display"), at([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === C.css(t, "float") && (l || (h.done(function() {
						p.display = c
					}), null == c && (u = p.display, c = "none" === u ? "" : u)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", h.always(function() {
						p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
					})), l = !1, f) l || (m ? "hidden" in m && (g = m.hidden) : m = V.access(t, "fxshow", {
					display: c
				}), r && (m.hidden = !g), g && at([t], !0), h.done(function() {
					for (i in g || at([t]), V.remove(t, "fxshow"), f) C.style(t, i, f[i])
				})), l = me(g ? m[i] : 0, i, h), i in m || (m[i] = l.start, g && (l.end = l.start, l.start = 0))
		}],
	...
	}, ce = T.createElement("input"), ue = T.createElement("select").appendChild(T.createElement("option")), ce.type = "checkbox", y.checkOn = "" !== ce.value, y.optSelected = ue.selected, (ce = T.createElement("input")).value = "t", ce.type = "radio", y.radioValue = "t" === ce.value;
	...
	C.fn.extend({
		...
		attr: function(t, e, n) {
			...
			if (3 !== r && 8 !== r && 2 !== r) return void 0 === t.getAttribute ? C.prop(t, e, n) : (1 === r && C.isXMLDoc(t) || (o = C.attrHooks[e.toLowerCase()] || (C.expr.match.bool.test(e) ? ye : void 0)), void 0 !== n ? null === n ? void C.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : null == (i = C.find.attr(t, e)) ? void 0 : i)
		},
		attrHooks: {
			type: {
				set: function(t, e) {
		...
		be[e] = function(t, e, n) {
			...
			return n || (o = be[r], be[r] = i, i = null != s(t, e, n) ? r : null, be[r] = o), i
		}
	});
	...
	C.fn.extend({
		...
		toggleClass: function(o, e) {
			...
			return "boolean" == typeof e && s ? e ? this.addClass(o) : this.removeClass(o) : b(o) ? this.each(function(t) {
				...
				var t, e, n, i;
				if (s)
					for (e = 0, n = C(this), i = Te(o); t = i[e++];) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
				else void 0 !== o && "boolean" != r || ((t = Se(this)) && V.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === o ? "" : V.get(this, "__className__") || ""))
			})
		},
		hasClass: function(t) {
			var e, n, i = 0;
			for (e = " " + t + " "; n = this[i++];)
				if (1 === n.nodeType && -1 < (" " + xe(Se(n)) + " ").indexOf(e)) return !0;
			return !1
		}
	});
	var Ce = /\r/g;
	C.fn.extend({
		val: function(n) {
			...
			})) : e ? (i = C.valHooks[e.type] || C.valHooks[e.nodeName.toLowerCase()]) && "get" in i && void 0 !== (t = i.get(e, "value")) ? t : "string" == typeof(t = e.value) ? t.replace(Ce, "") : null == t ? "" : t : void 0
		}
	}), C.extend({
		valHooks: {
			option: {
	...
	C.extend(C.event, {
		trigger: function(t, e, n, i) {
			...
			if (r = d = s = n = n || T, 3 !== n.nodeType && 8 !== n.nodeType && !ke.test(f + C.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), l = f.indexOf(":") < 0 && "on" + f, (t = t[C.expando] ? t : new C.Event(f, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), e = null == e ? [t] : C.makeArray(e, [t]), u = C.event.special[f] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, e))) {
				if (!i && !u.noBubble && !g(n)) {
					for (a = u.delegateType || f, ke.test(a + f) || (r = r.parentNode); r; r = r.parentNode) h.push(r), s = r;
					s === (n.ownerDocument || T) && h.push(s.defaultView || s.parentWindow || S)
				}
				for (o = 0;
					(r = h[o++]) && !t.isPropagationStopped();) d = r, t.type = 1 < o ? a : u.bindType || f, (c = (V.get(r, "events") || {})[t.type] && V.get(r, "handle")) && c.apply(r, e), (c = l && r[l]) && c.apply && Y(r) && (t.result = c.apply(r, e), !1 === t.result && t.preventDefault());
				return t.type = f, i || t.isDefaultPrevented() || u._default && !1 !== u._default.apply(h.pop(), e) || !Y(n) || l && b(n[f]) && !g(n) && ((s = n[l]) && (n[l] = null), C.event.triggered = f, t.isPropagationStopped() && d.addEventListener(f, Ee), n[f](), t.isPropagationStopped() && d.removeEventListener(f, Ee), C.event.triggered = void 0, s && (n[l] = s)), t.result
			}
		},
	...
	function je(n, t, i, o) {
		...
		if (Array.isArray(t)) C.each(t, function(t, e) {
			i || Pe.test(n) ? o(n, e) : je(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, i, o)
		});
	...
	C.param = function(t, e) {
		...
		serializeArray: function() {
			return this.map(function() {
				...
				var t = this.type;
				return this.name && !C(this).is(":disabled") && Oe.test(this.nodeName) && !Le.test(t) && (this.checked || !lt.test(t))
			}).map(function(t, e) {
				var n = C(this).val();
	...
	Ue.href = Ae.href, C.extend({
		...
		ajax: function(t, e) {
			...
			var u, d, h, n, f, i, p, g, o, r, m = C.ajaxSetup({}, e),
				v = m.context || m,
			...
			if (b.promise(x), m.url = ((t || m.url || Ae.href) + "").replace(Re, Ae.protocol + "//"), m.type = e.method || e.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(j) || [""], null == m.crossDomain) {
				i = T.createElement("a");
				try {
			...
			function c(t, e, n, i) {
				var o, r, s, a, l, c = e;
				p || (p = !0, f && S.clearTimeout(f), u = void 0, h = i || "", x.readyState = 0 < t ? 4 : 0, o = 200 <= t && t < 300 || 304 === t, n && (a = function(t, e, n) {
	...
	y.cors = !!Ke && "withCredentials" in Ke, y.ajax = Ke = !!Ke, C.ajaxTransport(function(o) {
		var r, s;
	...
	C.ajaxSetup({
		...
		if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = b(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Je, "$1" + i) : !1 !== t.jsonp && (t.url += (De.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
			return r || C.error(i + " was not called"), r[0]
		}, t.dataTypes[0] = "json", o = S[i], S[i] = function() {
			r = arguments
		}, n.always(function() {
			void 0 === o ? C(S).removeProp(i) : S[i] = o, t[i] && (t.jsonpCallback = e.jsonpCallback, Ze.push(i)), r && b(o) && o(r[0]), r = o = void 0
		}), "script"
	}), y.createHTMLDocument = ((Ge = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ge.childNodes.length), C.parseHTML = function(t, e, n) {
		return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (y.createHTMLDocument ? ((i = (e = T.implementation.createHTMLDocument("")).createElement("base")).href = T.location.href, e.head.appendChild(i)) : e = T), r = !n && [], (o = A.exec(t)) ? [e.createElement(o[1])] : (o = vt([t], e, r), r && r.length && C(r).remove(), C.merge([], o.childNodes)));
		var i, o, r
	}, C.fn.load = function(t, e, n) {
		var i, o, r, s = this,
			a = t.indexOf(" ");
		return -1 < a && (i = xe(t.slice(a)), t = t.slice(0, a)), b(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), 0 < s.length && C.ajax({
			url: t,
			type: o || "GET",
			dataType: "html",
			data: e
		...
		C.cssHooks[n] = Vt(y.pixelPosition, function(t, e) {
			if (e) return e = Xt(t, n), qt.test(e) ? C(t).position()[n] + "px" : e
		})
	}), C.each({
		Height: "height",
		Width: "width"
		...
		C.each({
			...
			C.fn[r] = function(t, e) {
				...
				return W(this, function(t, e, n) {
					var i;
					return g(t) ? 0 === r.indexOf("outer") ? t["inner" + s] : t.document.documentElement["client" + s] : 9 === t.nodeType ? (i = t.documentElement, Math.max(t.body["scroll" + s], i["scroll" + s], t.body["offset" + s], i["offset" + s], i["client" + s])) : void 0 === n ? C.css(t, e, o) : C.style(t, e, n, o)
				}, a, n ? t : void 0, n)
			}
		})
	...
	}, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = k, C.isFunction = b, C.isWindow = g, C.camelCase = Q, C.type = w, C.now = Date.now, C.isNumeric = function(t) {
		var e = C.type(t);
...
function(t, e) {
	...
	var n, o = "alert",
		...
		d = ((n = h.prototype).close = function(t) {
			var e = this._element;
	...
	p(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', d._handleDismiss(new d)), p.fn[o] = d._jQueryInterface, p.fn[o].Constructor = d, p.fn[o].noConflict = function() {
	...
	var f, m = "button",
		...
		T = ((f = C.prototype).toggle = function() {
			var t = !0,
				e = !0,
			...
			return this.each(function() {
				var t = p(this).data(v);
				t || (t = new C(this), p(this).data(v, t)), "toggle" === e && t[e]()
			})
		}, r(C, null, [{
			key: "VERSION",
			get: function() {
	...
	p(document).on(S.CLICK_DATA_API, x, function(t) {
		t.preventDefault();
		var e = t.target;
	...
	var E, k = "carousel",
		...
		F = ((E = R.prototype).next = function() {
			...
			if (this._touchSupported) {
				var e = function(t) {
						n._pointerEvent && H[t.originalEvent.pointerType.toUpperCase()] ? n.touchStartX = t.originalEvent.clientX : n._pointerEvent || (n.touchStartX = t.originalEvent.touches[0].clientX)
					},
					i = function(t) {
						n._pointerEvent && H[t.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = t.originalEvent.clientX - n.touchStartX), n._handleSwipe(), "hover" === n._config.pause && (n.pause(), n.touchTimeout && clearTimeout(n.touchTimeout), n.touchTimeout = setTimeout(function(t) {
							return n.cycle(t)
			...
			if (o = t === O ? (n = "carousel-item-left", i = "carousel-item-next", "left") : (n = "carousel-item-right", i = "carousel-item-prev", "right"), l && p(l).hasClass(M)) this._isSliding = !1;
				...
				if (p(this._element).hasClass("slide")) {
					...
					p(s).one(g.TRANSITION_END, function() {
						p(l).removeClass(n + " " + i).addClass(M), p(s).removeClass(M + " " + i + " " + n), r._isSliding = !1, setTimeout(function() {
							return p(r._element).trigger(d)
						}, 0)
					}).emulateTransitionEnd(f)
				} else p(s).removeClass(M), p(l).addClass(M), this._isSliding = !1, p(this._element).trigger(d);
				u && this.cycle()
			}
			...
			return this.each(function() {
				...
				if (t || (t = new R(this, e), p(this).data(A, t)), "number" == typeof i) t.to(i);
			...
			if (e) {
				...
				if (n && p(n).hasClass("carousel")) {
					...
					o && (i.interval = !1), R._jQueryInterface.call(p(n), i), o && p(n).data(A).to(o), t.preventDefault()
				}
			}
		}, r(R, null, [{
			key: "VERSION",
	...
	p(document).on(N.CLICK_DATA_API, "[data-slide], [data-slide-to]", F._dataApiClickHandler), p(window).on(N.LOAD_DATA_API, function() {
		for (var t = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), e = 0, n = t.length; e < n; e++) {
			var i = p(t[e]);
			F._jQueryInterface.call(i, i.data())
		}
	}), p.fn[k] = F._jQueryInterface, p.fn[k].Constructor = F, p.fn[k].noConflict = function() {
	...
	var W, q = "collapse",
		...
		et = ((W = nt.prototype).toggle = function() {
			p(this._element).hasClass(K) ? this.hide() : this.show()
		}, W.show = function() {
			var t, e, n = this;
			if (!(this._isTransitioning || p(this._element).hasClass(K) || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
				...
				if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
					t && (nt._jQueryInterface.call(p(t).not(this._selector), "hide"), e || p(t).data(B, null));
					var o = this._getDimension();
					p(this._element).removeClass(G).addClass(Z), this._element.style[o] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(J).attr("aria-expanded", !0), this.setTransitioning(!0);
					var r = "scroll" + (o[0].toUpperCase() + o.slice(1)),
						s = g.getTransitionDurationFromElement(this._element);
					p(this._element).one(g.TRANSITION_END, function() {
						p(n._element).removeClass(Z).addClass(G).addClass(K), n._element.style[o] = "", n.setTransitioning(!1), p(n._element).trigger(V.SHOWN)
			...
			if (!this._isTransitioning && p(this._element).hasClass(K)) {
				...
				if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
					...
					this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", g.reflow(this._element), p(this._element).addClass(Z).removeClass(G).removeClass(K);
					var i = this._triggerArray.length;
					if (0 < i)
						for (var o = 0; o < i; o++) {
							var r = this._triggerArray[o],
								s = g.getSelectorFromElement(r);
							null !== s && (p([].slice.call(document.querySelectorAll(s))).hasClass(K) || p(r).addClass(J).attr("aria-expanded", !1))
						}
					this.setTransitioning(!0), this._element.style[n] = "";
					var a = g.getTransitionDurationFromElement(this._element);
					p(this._element).one(g.TRANSITION_END, function() {
						t.setTransitioning(!1), p(t._element).removeClass(Z).addClass(G).trigger(V.HIDDEN)
			...
			p.removeData(this._element, B), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
		}, W._getConfig = function(t) {
			return (t = s({}, Y, t)).toggle = Boolean(t.toggle), g.typeCheckConfig(q, t, X), t
			...
			return this.each(function() {
				...
				if (!e && n.toggle && /show|hide/.test(i) && (n.toggle = !1), e || (e = new nt(this, n), t.data(B, e)), "string" == typeof i) {
	...
	}), p.fn[q] = et._jQueryInterface, p.fn[q].Constructor = et, p.fn[q].noConflict = function() {
		return p.fn[q] = Q, et._jQueryInterface
	};
	for (var it = "undefined" != typeof window && "undefined" != typeof document, ot = ["Edge", "Trident", "Firefox"], rt = 0, st = 0; st < ot.length; st += 1)
	...
	function gt(t) {
		...
		for (var e = pt(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling;) n = (t = t.nextElementSibling).offsetParent;
		var i = n && n.nodeName;
		return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TH", "TD", "TABLE"].indexOf(n.nodeName) && "static" === ct(n, "position") ? gt(n) : n : t ? t.ownerDocument.documentElement : document.documentElement
	}
	...
	function _t(t, e, n, i) {
		return Math.max(e["offset" + t], e["scroll" + t], n["client" + t], n["offset" + t], n["scroll" + t], pt(10) ? parseInt(n["offset" + t]) + parseInt(i["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0)
	}
	...
	function wt(t) {
		...
		return {
			height: _t("Height", e, n, i),
			width: _t("Width", e, n, i)
		}
	}
	...
	function Dt(t, e, n, i) {
		...
		if ("viewport" === i) r = function(t) {
			...
			var a = void 0;
			"scrollParent" === i ? "BODY" === (a = dt(ut(e))).nodeName && (a = t.ownerDocument.documentElement) : a = "window" === i ? t.ownerDocument.documentElement : i;
			var l = At(a, s, o);
	...
	function Mt(t, n, e) {
		return (void 0 === e ? t : t.slice(0, function(t, e, n) {
			...
			t.enabled && lt(e) && (n.offsets.popper = Et(n.offsets.popper), n.offsets.reference = Et(n.offsets.reference), n = e(n, t))
		}), n
	}
	...
	function Wt(n, i) {
		Object.keys(i).forEach(function(t) {
			var e = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && Rt(i[t]) && (e = "px"), n.style[t] = i[t] + e
		})
	}
			...
			modifiers: {
				...
				offset: {
					...
					fn: function(t, e) {
						var n, i = e.offset,
							...
							a = r.reference,
							l = o.split("-")[0];
						return n = Rt(+i) ? [+i, 0] : function(t, o, r, e) {
							var s = [0, 0],
								a = -1 !== ["right", "left"].indexOf(e),
								n = t.split(/(\+|\-)/).map(function(t) {
									return t.trim()
								}),
								i = n.indexOf(Nt(n, function(t) {
									return -1 !== t.search(/,|\s/)
								}));
					...
					fn: function(t, i) {
						...
						var c = i.priority,
							...
							d = {
								primary: function(t) {
									var e = u[t];
									return u[t] < l[t] && !i.escapeWithReference && (e = Math.max(u[t], l[t])), xt({}, t, e)
								},
								secondary: function(t) {
									var e = "right" === t ? "left" : "top",
										n = u[e];
									return u[t] > l[t] && !i.escapeWithReference && (n = Math.min(u[e], l[t] - ("right" === t ? u.width : u.height))), xt({}, e, n)
								}
							};
				...
				arrow: {
					...
					fn: function(t, e) {
						...
						var o = t.placement.split("-")[0],
							...
							f = l ? "bottom" : "right",
							p = Lt(i)[c];
						a[f] - p < s[d] && (t.offsets.popper[d] -= s[d] - (a[f] - p)), a[d] + p > s[f] && (t.offsets.popper[d] += a[d] + p - s[f]), t.offsets.popper = Et(t.offsets.popper);
						var g = a[d] + a[c] / 2 - p / 2,
							m = ct(t.instance.popper),
							v = parseFloat(m["margin" + u], 10),
							y = parseFloat(m["border" + u + "Width"], 10),
							b = g - t.offsets.popper[d] - v - y;
						return b = Math.max(Math.min(s[c] - p, b), 0), t.arrowElement = i, t.offsets.arrow = (xt(n = {}, d, Math.round(b)), xt(n, h, ""), n), t
					},
					element: "[x-arrow]"
				},
				flip: {
					...
					fn: function(p, g) {
						...
						return _.forEach(function(t, e) {
							...
							var n, i = p.offsets.popper,
								...
								f = !!g.flipVariations && (h && "start" === b && a || h && "end" === b && l || !h && "start" === b && c || !h && "end" === b && u);
							(s || d || f) && (p.flipped = !0, (s || d) && (v = _[e + 1]), f && (b = "end" === (n = b) ? "start" : "start" === n ? "end" : n), p.placement = v + (b ? "-" + b : ""), p.offsets.popper = Tt({}, p.offsets.popper, jt(p.instance.popper, p.offsets.reference, p.placement)), p = Mt(p.instance.modifiers, p, "flip"))
						}), p
					},
					behavior: "flip",
					padding: 5,
				...
				inner: {
					...
					fn: function(t) {
						...
						return o[s ? "left" : "top"] = r[n] - (a ? o[s ? "width" : "height"] : 0), t.placement = Ot(e), t.offsets.popper = Et(o), t
					}
				},
				hide: {
					order: 800,
				...
				computeStyle: {
					...
					fn: function(t, e) {
						...
						var s, a, l, c, u, d, h, f, p, g, m, v, y, b, _, w, x = void 0 !== r ? r : e.gpuAcceleration,
							S = gt(t.instance.popper),
							T = kt(S),
							C = {
								position: o.position
							},
							E = (s = t, a = window.devicePixelRatio < 2 || !qt, c = (l = s.offsets).popper, u = l.reference, d = Math.round, h = Math.floor, f = function(t) {
								return t
							}, p = d(u.width), g = d(c.width), m = -1 !== ["left", "right"].indexOf(s.placement), v = -1 !== s.placement.indexOf("-"), b = a ? d : f, {
								left: (y = a ? m || v || p % 2 == g % 2 ? d : h : f)(p % 2 == 1 && g % 2 == 1 && !v && a ? c.left - 1 : c.left),
								top: b(c.top),
								bottom: b(c.bottom),
								right: y(c.right)
							}),
							...
							I = Ht("transform");
						if (w = "bottom" == k ? "HTML" === S.nodeName ? -S.clientHeight + E.bottom : -T.height + E.bottom : E.top, _ = "right" == A ? "HTML" === S.nodeName ? -S.clientWidth + E.right : -T.width + E.right : E.left, x && I) C[I] = "translate3d(" + _ + "px, " + w + "px, 0)", C[k] = 0, C[A] = 0, C.willChange = "transform";
						else {
							var D = "bottom" == k ? -1 : 1,
								P = "right" == A ? -1 : 1;
						...
						return t.attributes = Tt({}, $, t.attributes), t.styles = Tt({}, C, t.styles), t.arrowStyles = Tt({}, t.offsets.arrow, t.arrowStyles), t
					},
					gpuAcceleration: !0,
					x: "bottom",
					y: "right"
				...
				applyStyle: {
					...
					onLoad: function(t, e, n, i, o) {
						var r = $t(o, e, t, n.positionFixed),
							s = Pt(n.placement, r, e, t, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
						return e.setAttribute("x-placement", s), Wt(e, {
			...
			value: function() {
				return function() {
					if (!this.state.isDestroyed) {
						...
						t.offsets.reference = $t(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = Pt(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = jt(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = Mt(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t))
					}
				}.call(this)
			}
		}, {
					...
					this.state.eventsEnabled || (this.state = function(t, e, n, i) {
						...
						return function t(e, n, i, o) {
							...
							s.addEventListener(n, i, {
								passive: !0
							}), r || t(dt(s.parentNode), n, i, o), o.push(s)
	...
	function Kt(t, e) {
		...
		! function(t, e) {
			if (!(t instanceof Kt)) throw new TypeError("Cannot call a class as a function")
		}(this), this.scheduleUpdate = function() {
			return requestAnimationFrame(n.update)
		}, this.update = at(this.update.bind(this)), this.options = Tt({}, Kt.Defaults, i), this.state = {
			isDestroyed: !1,
			isCreated: !1,
			scrollParents: []
		}, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(Tt({}, Kt.Defaults.modifiers, i.modifiers)).forEach(function(t) {
			n.options.modifiers[t] = Tt({}, Kt.Defaults.modifiers[t] || {}, i.modifiers ? i.modifiers[t] : {})
			...
			t.enabled && lt(t.onLoad) && t.onLoad(n.reference, n.popper, n.options, t, n.state)
		}), this.update();
		var o = this.options.eventsEnabled;
		o && this.enableEventListeners(), this.state.eventsEnabled = o
	}
	Vt.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Vt.placements = Ut, Vt.Defaults = Xt;
	var Gt, Zt = "dropdown",
		Jt = "bs.dropdown",
		te = "." + Jt,
		ee = ".data-api",
		...
		he = ((Gt = fe.prototype).toggle = function() {
				...
				if (fe._clearMenus(), !e) {
					...
					if (p(t).trigger(i), !i.isDefaultPrevented()) {
						if (!this._inNavbar) {
							...
							var o = this._element;
							"parent" === this._config.reference ? o = t : g.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(t).addClass("position-static"), this._popper = new Vt(o, this._menu, this._getPopperConfig())
						}
						"ontouchstart" in document.documentElement && 0 === p(t).closest(".navbar-nav").length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(se), p(t).toggleClass(se).trigger(p.Event(oe.SHOWN, n))
					}
				}
			}
		}, Gt.show = function() {
			if (!(this._element.disabled || p(this._element).hasClass(re) || p(this._menu).hasClass(se))) {
				var t = {
						relatedTarget: this._element
					},
					e = p.Event(oe.SHOW, t),
					n = fe._getParentFromElement(this._element);
				p(n).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass(se), p(n).toggleClass(se).trigger(p.Event(oe.SHOWN, t)))
			}
		}, Gt.hide = function() {
			if (!this._element.disabled && !p(this._element).hasClass(re) && p(this._menu).hasClass(se)) {
				var t = {
					...
					e = p.Event(oe.HIDE, t),
					n = fe._getParentFromElement(this._element);
				p(n).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass(se), p(n).toggleClass(se).trigger(p.Event(oe.HIDDEN, t)))
			}
		}, Gt.dispose = function() {
			p.removeData(this._element, Jt), p(this._element).off(te), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
		}, Gt.update = function() {
			...
			return t = s({}, this.constructor.Default, p(this._element).data(), t), g.typeCheckConfig(Zt, t, this.constructor.DefaultType), t
			...
			var t = p(this._element.parentNode),
				e = "bottom-start";
			return t.hasClass("dropup") ? (e = "top-start", p(this._menu).hasClass(ae) && (e = "top-end")) : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : p(this._menu).hasClass(ae) && (e = "bottom-end"), e
			...
			return this.each(function() {
				...
				if (t || (t = new fe(this, "object" == typeof e ? e : null), p(this).data(Jt, t)), "string" == typeof e) {
			...
			if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
				for (var e = [].slice.call(document.querySelectorAll(le)), n = 0, i = e.length; n < i; n++) {
					...
					if (t && "click" === t.type && (s.clickEvent = t), r) {
						var a = r._menu;
						if (p(o).hasClass(se) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(o, t.target))) {
							var l = p.Event(oe.HIDE, s);
							p(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), e[n].setAttribute("aria-expanded", "false"), p(a).removeClass(se), p(o).removeClass(se).trigger(p.Event(oe.HIDDEN, s)))
						}
					}
				}
			...
			if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(ce).length)) : ie.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(re))) {
	...
	p(document).on(oe.KEYDOWN_DATA_API, le, he._dataApiKeydownHandler).on(oe.KEYDOWN_DATA_API, ce, he._dataApiKeydownHandler).on(oe.CLICK_DATA_API + " " + oe.KEYUP_DATA_API, he._clearMenus).on(oe.CLICK_DATA_API, le, function(t) {
		t.preventDefault(), t.stopPropagation(), he._jQueryInterface.call(p(this), "toggle")
	}).on(oe.CLICK_DATA_API, ".dropdown form", function(t) {
		t.stopPropagation()
	}), p.fn[Zt] = he._jQueryInterface, p.fn[Zt].Constructor = he, p.fn[Zt].noConflict = function() {
	...
	var pe, ge = "modal",
		...
		Ee = ".sticky-top",
		ke = ((pe = Ae.prototype).toggle = function(t) {
			...
			if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
				...
				if (p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
					...
					if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(we.FOCUSIN), p(this._element).removeClass(Te), p(this._element).off(we.CLICK_DISMISS), p(this._dialog).off(we.MOUSEDOWN_DISMISS), i) {
			...
			[window, this._element, this._dialog].forEach(function(t) {
				return p(t).off(ve)
			}), p(document).off(we.FOCUSIN), p.removeData(this._element, me), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
			...
			this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass("modal-dialog-scrollable") ? this._dialog.querySelector(".modal-body").scrollTop = 0 : this._element.scrollTop = 0, n && g.reflow(this._element), p(this._element).addClass(Te), this._config.focus && this._enforceFocus();
			...
			this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() {
				p(document.body).removeClass(xe), t._resetAdjustments(), t._resetScrollbar(), p(t._element).trigger(we.HIDDEN)
			})
			...
			if (this._isShown && this._config.backdrop) {
				if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", n && this._backdrop.classList.add(n), p(this._backdrop).appendTo(document.body), p(this._element).on(we.CLICK_DISMISS, function(t) {
					...
					}), n && g.reflow(this._backdrop), p(this._backdrop).addClass(Te), !t) return;
				if (!n) return void t();
			...
			return this.each(function() {
				...
				if (t || (t = new Ae(this, e), p(this).data(me, t)), "string" == typeof n) {
					if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
					t[n](i)
	...
	}), p.fn[ge] = ke._jQueryInterface, p.fn[ge].Constructor = ke, p.fn[ge].noConflict = function() {
		...
		for (var n = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function(t, e) {
				...
				o.forEach(function(t) {
					! function(t, e) {
						...
						if (-1 !== e.indexOf(n)) return -1 === Ie.indexOf(n) || Boolean(t.nodeValue.match(De) || t.nodeValue.match(Pe));
	...
	var Le, Oe = "tooltip",
		...
		Xe = "hover",
		Ve = "focus",
		Ke = ((Le = Ge.prototype).enable = function() {
			this._isEnabled = !0
		}, Le.disable = function() {
			this._isEnabled = !1
			...
			if (this.isWithContent() && this._isEnabled) {
				...
				o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && p(o).addClass(Qe);
				var s = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
					a = this._getAttachment(s);
				this.addAttachmentClass(a);
				var l = this._getContainer();
				p(o).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(o).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new Vt(this.element, o, {
					placement: a,
					modifiers: {
						offset: this._getOffset(),
						flip: {
				...
				}), p(o).addClass(Ye), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
				var c = function() {
			...
			function e() {
				n._hoverState !== Be && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), p(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), t && t()
			}
			var n = this,
				i = this.getTipElement(),
				o = p.Event(this.constructor.Event.HIDE);
			if (p(this.element).trigger(o), !o.isDefaultPrevented()) {
				if (p(i).removeClass(Ye), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger.click = !1, this._activeTrigger[Ve] = !1, this._activeTrigger[Xe] = !1, p(this.tip).hasClass(Qe)) {
			...
			this.setElementContent(p(t.querySelectorAll(".tooltip-inner")), this.getTitle()), p(t).removeClass(Qe + " " + Ye)
		}, Le.setElementContent = function(t, e) {
			"object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = $e(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? p(e).parent().is(t) || t.empty().append(e) : t.text(p(e).text())
			...
			var n = this.constructor.DATA_KEY;
			(e = e || p(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), p(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusout" === t.type ? Ve : Xe] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = "out", e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
			...
			return Object.keys(e).forEach(function(t) {
				...
				show: t.delay,
				hide: t.delay
			}), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), g.typeCheckConfig(Oe, t, this.constructor.DefaultType), t.sanitize && (t.template = $e(t.template, t.whiteList, t.sanitizeFn)), t
			...
			return this.each(function() {
				var t = p(this).data(je),
					e = "object" == typeof n && n;
				if ((t || !/dispose|hide/.test(n)) && (t || (t = new Ge(this, e), p(this).data(je, t)), "string" == typeof n)) {
					if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
					t[n]()
				}
			})
	...
	p.fn[Oe] = Ke._jQueryInterface, p.fn[Oe].Constructor = Ke, p.fn[Oe].noConflict = function() {
		...
		ln = function(t) {
			...
			return o.isWithContent = function() {
				...
				return this.each(function() {
					...
					if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), p(this).data(Je, t)), "string" == typeof n)) {
						if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
						t[n]()
					}
				})
	...
	p.fn[Ze] = ln._jQueryInterface, p.fn[Ze].Constructor = ln, p.fn[Ze].noConflict = function() {
	...
	var cn, un = "scrollspy",
		...
		_n = ".list-group-item",
		wn = "position",
		xn = ((cn = Sn.prototype).refresh = function() {
			var e = this,
			...
			p.removeData(this._element, dn), p(this._scrollElement).off(hn), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
		}, cn._getConfig = function(t) {
			if ("string" != typeof(t = s({}, pn, "object" == typeof t && t ? t : {})).target) {
			...
			return this.each(function() {
				...
				if (t || (t = new Sn(this, "object" == typeof e && e), p(this).data(dn, t)), "string" == typeof e) {
					if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
					t[e]()
				}
			})
	...
	function Sn(t, e) {
		var n = this;
		this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + bn + "," + this._config.target + " " + _n + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(mn.SCROLL, function(t) {
			return n._process(t)
	...
	var Tn, Cn = "bs.tab",
		...
		Dn = ".active",
		Pn = "> li > .active",
		$n = ((Tn = Ln.prototype).show = function() {
			var n = this;
			...
			var o = this,
				r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children(Dn) : p(e).find(Pn))[0],
			...
			return this.each(function() {
				var t = p(this),
					e = t.data(Cn);
				if (e || (e = new Ln(this), t.data(Cn, e)), "string" == typeof n) {
	...
	}), p.fn.tab = $n._jQueryInterface, p.fn.tab.Constructor = $n, p.fn.tab.noConflict = function() {
	...
	var On, jn = "toast",
		...
		Bn = ((On = Un.prototype).show = function() {
			var t = this;

			function e() {
				t._element.classList.remove(Rn), t._element.classList.add(Fn), p(t._element).trigger(Hn.SHOWN), t._config.autohide && t.hide()
			}
			if (p(this._element).trigger(Hn.SHOW), this._config.animation && this._element.classList.add("fade"), this._element.classList.remove("hide"), this._element.classList.add(Rn), this._config.animation) {
				var n = g.getTransitionDurationFromElement(this._element);
				p(this._element).one(g.TRANSITION_END, e).emulateTransitionEnd(n)
			} else e()
		}, On.hide = function(t) {
			var e = this;
			this._element.classList.contains(Fn) && (p(this._element).trigger(Hn.HIDE), t ? this._close() : this._timeout = setTimeout(function() {
				e._close()
			}, this._config.delay))
		}, On.dispose = function() {
			clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Fn) && this._element.classList.remove(Fn), p(this._element).off(Hn.CLICK_DISMISS), p.removeData(this._element, Nn), this._element = null, this._config = null
		}, On._getConfig = function(t) {
			return t = s({}, qn, p(this._element).data(), "object" == typeof t && t ? t : {}), g.typeCheckConfig(jn, t, this.constructor.DefaultType), t
		}, On._setListeners = function() {
			var t = this;
			p(this._element).on(Hn.CLICK_DISMISS, '[data-dismiss="toast"]', function() {
				return t.hide(!0)
			})
		}, On._close = function() {
			function t() {
			...
			return this.each(function() {
				var t = p(this),
					e = t.data(Nn);
				if (e || (e = new Un(this, "object" == typeof n && n), t.data(Nn, e)), "string" == typeof n) {
					if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
					e[n](this)
				}
			})
	...
	p.fn[jn] = Bn._jQueryInterface, p.fn[jn].Constructor = Bn, p.fn[jn].noConflict = function() {
		...
		}(), t.Util = g, t.Alert = d, t.Button = T, t.Carousel = F, t.Collapse = et, t.Dropdown = he, t.Modal = ke, t.Popover = ln, t.Scrollspy = xn, t.Tab = $n, t.Toast = Bn, t.Tooltip = Ke, Object.defineProperty(t, "__esModule", {
			value: !0
		})
}),
function(t, e) {
...
function() {
	...
	i.prototype.hasNext = function() {
		...
		var e, n, i, o, r, s, a, l, c, u, d, h, f, p, g, m, v, y, b, _, w, x, S, T, C, E, k, A;
		if ("object" != typeof t) {
		...
		if ("undefined" != typeof document && null !== document && !1 === this.options.mock) {
			if (h = t.data, T = parseInt(this.options.limit, 10), null != this.options.limit && h.length > T && (h = h.slice(0, T)), s = document.createDocumentFragment(), null != this.options.filter && "function" == typeof this.options.filter && (h = this._filter(h, this.options.filter)), null != this.options.template && "string" == typeof this.options.template) {
				for (a = "", A = document.createElement("div"), l = 0, _ = h.length; l < _; l++) {
					if ("object" != typeof(u = (c = h[l]).images[this.options.resolution])) throw r = "No image found for resolution: " + this.options.resolution + ".", new Error(r);
				...
				for (b = 0, x = h.length; b < x; b++) {
					if (c = h[b], f = document.createElement("img"), "object" != typeof(u = c.images[this.options.resolution])) throw r = "No image found for resolution: " + this.options.resolution + ".", new Error(r);
					d = u.url, 0 <= window.location.protocol.indexOf("http") && !this.options.useHttp && (d = d.replace(/https?:\/\//, "//")), f.src = d, !0 === this.options.links ? ((e = document.createElement("a")).href = c.link, e.appendChild(f), s.appendChild(e)) : s.appendChild(f)
				}
		...
		var n, i, o, r, s;
		for (i = /(?:\{{2})([\w\[\]\.]+)(?:\}{2})/, n = t; i.test(n);) r = n.match(i)[1], s = null != (o = this._getObjectProperty(e, r)) ? o : "", n = n.replace(i, function() {
			return "" + s
		});
		return n
		...
		return e = function(t, e) {
			var n, i;
			return n = this._getObjectProperty(t, o), i = this._getObjectProperty(e, o), r ? i < n ? 1 : -1 : n < i ? 1 : -1
		...
		return t
	}, "function" == typeof define && define.amd ? define([], n) : "object" == typeof module && module.exports ? module.exports = n() : e.Instafeed = n()
}.call(this),
	function(e, n) {
	...
	function(t, e) {
		...
		function b(t) {
			if (function() {
					if (!S) {
						...
						e.appendChild(t);
						var n = y(t);
						_ = 200 == Math.round(v(n.width)), b.isBoxSizeOuter = _, e.removeChild(t)
					}
				...
				for (var i = n.isBorderBox = "border-box" == e.boxSizing, o = 0; o < x; o++) {
					var r = w[o],
						s = e[r],
						a = parseFloat(s);
					n[r] = isNaN(a) ? 0 : a
		...
		var _, n = "undefined" == typeof console ? function() {} : function(t) {
				console.error(t)
			},
	...
	function(c) {
		...
		c.ajaxChimp = {
			...
			return c(this).each(function(t, e) {
				var o = c(e),
				...
				o.attr("novalidate", "true"), r.attr("name", "EMAIL"), o.submit(function() {
							...
							if ("success" === e.result) i = "We have sent you a confirmation email", s.removeClass("error").addClass("valid"), r.removeClass("error").addClass("valid");
								...
								try {
									...
									if (void 0 === t[1]) i = e.msg;
										...
										i = n.toString() === t[0] ? (t[0], t[1]) : e.msg
									}
								} catch (t) {
									i = e.msg
								}
							}
							"en" !== a.language && void 0 !== c.ajaxChimp.responses[i] && c.ajaxChimp.translations && c.ajaxChimp.translations[a.language] && c.ajaxChimp.translations[a.language][c.ajaxChimp.responses[i]] && (i = c.ajaxChimp.translations[a.language][c.ajaxChimp.responses[i]]), s.html(i), s.show(2e3), a.callback && a.callback(e)
						},
						dataType: "jsonp",
						error: function(t, e) {
					...
					var e = "Submitting...";
					return "en" !== a.language && c.ajaxChimp.translations && c.ajaxChimp.translations[a.language] && c.ajaxChimp.translations[a.language].submit && (e = c.ajaxChimp.translations[a.language].submit), s.html(e).show(2e3), !1
				})
			}), this
		}
	}(jQuery),
						...
						if (a)
							for (var l = 0, c = a.length; l < c; ++l) {
								var u = a[l].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),
									...
									f = u[3] || "",
									p = null;
								u = u[2], m.hasOwnProperty(u) && (p = m[u], p = Number(g[p])), null !== p && ("!" === h && (n = p, o = i = void 0, i = "s", o = "", (e = f) && (e = e.replace(/(:|;|\s)/gi, "").split(/\,/), i = 1 === e.length ? e[0] : (o = e[0], e[1])), p = 1 < Math.abs(n) ? i : o), "" === h && p < 10 && (p = "0" + p.toString()), t = t.replace(d, p.toString()))
							}
						return t.replace(/%%/, "%")
					}
		...
		if (l.console = l.console || {
			...
			var e = {
				...
				i = function(t, e, n) {
					...
					i.opts = d({
						index: n
					}, g.fancybox.defaults), g.isPlainObject(e) && (i.opts = d(i.opts, e)), g.fancybox.isMobile && (i.opts = d(i.opts, i.opts.mobile)), i.id = i.opts.id || ++s, i.currIndex = parseInt(i.opts.index, 10) || 0, i.prevIndex = null, i.prevPos = null, i.currPos = 0, i.firstRun = !0, i.group = [], i.slides = {}, i.addContent(t), i.group.length && i.init()
				};
			g.extend(i.prototype, {
				...
				addEvents: function() {
					...
					i.removeEvents(), i.$refs.container.on("click.fb-close", "[data-fancybox-close]", function(t) {
						...
						t && t.originalEvent && "resize" === t.originalEvent.type ? (i.requestId && a(i.requestId), i.requestId = h(function() {
							i.update(t)
				...
				scaleToActual: function(t, e, n) {
					var i, o, r, s, a, l = this,
						...
						f = c.width,
						p = c.height;
					l.isAnimating || l.isMoved() || !u || "image" != c.type || !c.isLoaded || c.hasError || (l.isAnimating = !0, g.fancybox.stop(u), t = void 0 === t ? .5 * d : t, e = void 0 === e ? .5 * h : e, (i = g.fancybox.getTranslate(u)).top -= g.fancybox.getTranslate(c.$slide).top, i.left -= g.fancybox.getTranslate(c.$slide).left, s = f / i.width, a = p / i.height, o = .5 * d - .5 * f, r = .5 * h - .5 * p, d < f && (0 < (o = i.left * s - (t * s - t)) && (o = 0), o < d - f && (o = d - f)), h < p && (0 < (r = i.top * a - (e * a - e)) && (r = 0), r < h - p && (r = h - p)), l.updateCursor(f, p), g.fancybox.animate(u, {
						top: r,
						left: o,
						scaleX: s,
						scaleY: a
				...
				focus: function(t, e) {
					...
					})).length ? (i = n.index(c.activeElement), t && t.shiftKey ? (i < 0 || 0 == i) && (t.preventDefault(), n.eq(n.length - 1).trigger("focus")) : (i < 0 || i == n.length - 1) && (t && t.preventDefault(), n.eq(0).trigger("focus"))) : this.$refs.container.trigger("focus"))
				},
				activate: function() {
					var e = this;
				...
				close: function(t, e) {
					...
					return !u.isClosing && (!(u.isClosing = !0) === u.trigger("beforeClose", t) ? (u.isClosing = !1, h(function() {
						...
						width: c.width,
						height: c.height
					}, "auto" == (a = d.opts.zoomOpacity) && (a = .1 < Math.abs(d.width / d.height - c.width / c.height)), a && (c.opacity = 0), g.fancybox.setTranslate(r, l), f(r), g.fancybox.animate(r, c, o, n)) : i && o ? g.fancybox.animate(d.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + i, o, n) : !0 === t ? setTimeout(n, o) : n(), !0))
				},
				cleanUp: function(t) {
				...
				animate: function(e, n, i, o, r) {
					var s, a = this;
					g.isFunction(i) && (o = i, i = null), a.stop(e), s = a.getTranslate(e), e.on(u, function(t) {
			...
			}), p = null, r.on("mousedown mouseup focus blur", ".fancybox-button", function(t) {
				switch (t.type) {
					case "mousedown":
						p = g(this);
						break;
		...
		f(document).on("objectNeedsType.fb", function(t, e, o) {
			...
			n = f.extend(!0, {}, i, o.opts.media), f.each(n, function(t, e) {
				if (s = d.match(e.matcher)) {
					...
					return a = f.extend(!0, {}, e.params, o.opts[t], c), d = "function" === f.type(e.url) ? e.url.call(this, s, a, o) : p(e.url, s, a), r = "function" === f.type(e.thumb) ? e.thumb.call(this, s, a, o) : p(e.thumb, s), "youtube" === t ? d = d.replace(/&t=((\d+)m)?(\d+)s/, function(t, e, n, i) {
	...
	function(g, l, m) {
		...
		n.prototype.destroy = function() {
			...
			var t, e, n, i, o, r, s = this.canvasWidth,
				...
				f = u.width,
				p = u.height;
			return o = s < f ? d + l : d, r = h + c, t = Math.max(0, .5 * s - .5 * f), e = Math.max(0, .5 * a - .5 * p), n = Math.min(s - f, .5 * s - .5 * f), i = Math.min(a - p, .5 * a - .5 * p), 0 < l && t < o && (o = t - 1 + Math.pow(-t + d + l, .8) || 0), l < 0 && o < n && (o = n + 1 - Math.pow(n - d - l, .8) || 0), 0 < c && e < r && (r = e - 1 + Math.pow(-e + h + c, .8) || 0), c < 0 && r < i && (r = i + 1 - Math.pow(i - h - c, .8) || 0), {
				top: r,
				left: o
			}
		...
		e.fn.meanmenu = function(k) {
			...
			return this.each(function() {
				...
				var w = "",
					x = !1,
					S = !1;
				"right" === e && (w = "right:" + t + ";left:auto;"), "left" === e && (w = "left:" + t + ";right:auto;"), _();
				...
				function C() {
					...
					if (A <= l) {
						jQuery(y).addClass("mean-remove"), S = !0, jQuery(i).addClass("mean-container"), jQuery(".mean-container").prepend('<div class="mean-bar"><a href="#nav" class="meanmenu-reveal" style="' + t + '">Show Navigation</a><nav class="mean-nav"></nav></div>');
						var e = jQuery(n).html();
						jQuery(".mean-nav").html(e), g && jQuery("nav.mean-nav ul, nav.mean-nav ul *").each(function() {
							jQuery(this).is(".mean-remove") ? jQuery(this).attr("class", "mean-remove") : jQuery(this).removeAttr("class"), jQuery(this).removeAttr("id")
						}), jQuery(n).before('<div class="mean-push" />'), jQuery(".mean-push").css("margin-top", c), jQuery(n).hide(), jQuery(".meanmenu-reveal").show(), jQuery(u).html(s), E = jQuery(u), jQuery(".mean-nav ul").hide(), d ? h ? (jQuery(".mean-nav ul ul").each(function() {
							...
							t.preventDefault(), jQuery(this).hasClass("mean-clicked") ? (jQuery(this).text(f), jQuery(this).prev("ul").slideUp(300, function() {})) : (jQuery(this).text(p), jQuery(this).prev("ul").slideDown(300, function() {})), jQuery(this).toggleClass("mean-clicked")
							...
							t.preventDefault(), x = !1 === x ? (E.css("text-align", "center"), E.css("text-indent", "0"), E.css("font-size", r), jQuery(".mean-nav ul:first").slideDown(), !0) : (jQuery(".mean-nav ul:first").slideUp(), !1), E.toggleClass("meanclose"), E.html(jQuery(E).is(".meanmenu-reveal.meanclose") ? o : s), jQuery(y).addClass("mean-remove")
						}), m && jQuery(".mean-nav ul > li > a:first-child").on("click", function() {
							jQuery(".mean-nav ul:first").slideUp(), x = !1, jQuery(E).toggleClass("meanclose").html(s)
						})
					} else T()
				}
				var E = "";
				b || jQuery(window).resize(function() {
					A = window.innerWidth || document.documentElement.clientWidth, T(), A <= l ? (C(), _()) : T()
				}), jQuery(window).resize(function() {
					A = window.innerWidth || document.documentElement.clientWidth, b ? (_(), A <= l ? !1 === S && C() : T()) : (T(), A <= l && (C(), _()))
				}), C()
			})
		}
	}(jQuery),
	...
	function(_) {
		var w, x, g, S, m, v, y, b, l, T = {
				...
				getSliderValuesAtPositionPx: function(t, e) {
					...
					if (void 0 !== o) n = o(t), i = o(e);
						...
						n = T.inverse_rangemap_0_to_n.call(this, t, r), i = T.inverse_rangemap_0_to_n.call(this, e, r)
					}
					return [n, i]
				},
				validateAndMoveGripsToPx: function(t, e) {
					var n = T.getSliderWidthPx.call(this) - this.data("left_grip_width");
					if (e <= n && 0 <= t && t <= n && (!this.data("has_right_grip") || t <= e)) {
						var i = this.data("cur_min"),
							o = this.data("cur_max");
						T.set_position_from_px.call(this, t, e), T.refresh_grips_style.call(this), T.notify_changed_implicit.call(this, "drag_move", i, o)
					}
					return this
				},
				updateAriaAttributes: function() {
					...
					if (t.data("has_right_grip")) {
						...
						n.attr("aria-valuemin", t.data("range_min")).attr("aria-valuenow", C.get_current_min_value.call(t)).attr("aria-valuemax", C.get_current_max_value.call(t)), i.attr("aria-valuemin", C.get_current_min_value.call(t)).attr("aria-valuenow", C.get_current_max_value.call(t)).attr("aria-valuemax", t.data("range_max"))
					} else n.attr("aria-valuemin", t.data("range_min")).attr("aria-valuenow", C.get_current_min_value.call(t)).attr("aria-valuemax", t.data("range_max"));
					return t
				},
				...
				getRightGripPositionPx: function() {
					var t = this.data("settings");
					if (this.data("has_right_grip")) return T.getGripPositionPx.call(this, this.find(t.right_grip_selector));
				...
				binarySearchValueToPxCompareFunc: function(t, e, n) {
					return t === e[n] ? 0 : t < e[n] && 0 === n ? 0 : e[n - 1] <= t && t < e[n] ? 0 : t > e[n] ? 1 : t <= e[n - 1] ? -1 : void _.error("cannot compare s: " + t + " with a[" + n + "]. a is: " + e.join(","))
				},
				...
				refresh_grips_style: function() {
					...
					if (void 0 !== t.highlight) {
						...
						if (void 0 !== e) {
							...
							r < e || o < r ? n.removeClass(a) : n.addClass(a), s < e || o < s ? i.removeClass(a) : i.addClass(a)
						}
					}
				},
				set_position_from_val: function(t, e) {
					var n = this,
						i = n.data("range_min"),
						o = n.data("range_max");
					t < i && (t = i), o < t && (t = o), n.data("has_right_grip") ? (o < e && (e = o), e < i && (e = i)) : e = n.data("cur_max");
					var r = C.value_to_px.call(n, t),
						s = C.value_to_px.call(n, e);
					return T.set_handles_at_px.call(n, r, s), n.data("cur_min", t), n.data("has_right_grip") && n.data("cur_max", e), n
				},
				...
				set_handles_at_px: function(t, e) {
					...
					return n.find(o).css("left", t + "px"), n.find(r).css("left", e + "px"), n.data("has_right_grip") ? n.find(s).css("left", t + "px").css("width", e - t + a + "px") : (l || T.populateNakedBarDeltas.call(n, t, e, a), t < e ? n.find(s).css("left", t + "px").css("width", e - t + l.toEndWidth + "px") : n.find(s).css("left", e + l.toBeginLeft + "px").css("width", t - e + l.toBeginWidth + "px")), n
				},
				drag_start_func_touch: function(t, e, n, i, o) {
					var r = t.originalEvent,
						...
						d = u - l,
						h = l - (u + this.width());
					c > e.touch_tolerance_value_bar_y || d > e.touch_tolerance_value_bar_x || h > e.touch_tolerance_value_bar_x || (r.preventDefault(), g = s.pageX, T.drag_start_func.call(this, s, e, n, i, o))
				},
				drag_start_func: function(t, e, n, i, o) {
					var r = this;
					if (r.find(e.left_grip_selector + "," + e.value_bar_selector + "," + e.right_grip_selector).removeClass(e.animating_css_class), C.is_enabled.call(r)) {
						var s = _(t.target),
							a = !1;
						if ("object" == typeof e.highlight && (a = s.is(e.highlight.panel_selector)), !1 !== o || s.is(e.left_grip_selector) || s.is(e.right_grip_selector) || s.is(e.value_bar_selector) || a || s.is(r)) {
							w = r;
							var l, c, u, d, h, f, p = T.getGripPositionPx.call(r, n),
								g = T.getSliderWidthPx.call(r) - r.data("left_grip_width"),
								m = n.offset().left,
								v = T.getRightGripPositionPx.call(r);
							c = Math.round(t.pageX) - r.data("left_grip_width") / 2, u = Math.abs(m - c), h = c - m, f = r.data("has_right_grip") ? (l = i.offset().left, d = Math.abs(l - c), c - l) : (d = 2 * u, 2 * h), e.user_drag_start_callback.call(r, t), S = u === d ? c < m ? (p += h, !0) : (v += f, !1) : u < d ? (p += h, !0) : (v += f, !1), r.data("has_right_grip") ? g < v && (v = g) : g < p && (p = g), p < 0 && (p = 0), x = !0;
							var y = r.data("cur_min"),
								b = r.data("cur_max");
							T.set_position_from_px.call(r, p, v), T.refresh_grips_style.call(r), T.notify_changed_implicit.call(r, "drag_start", y, b), "[object Touch]" !== Object.prototype.toString.apply(t) && t.preventDefault()
						}
					}
				},
				...
				drag_move_func: function(t) {
					if (x) {
						var e = w,
							...
							u = c + i;
						!1 === n.crossable_handles && e.data("has_right_grip") && (S ? u = c + r : c += o);
						var d = 0,
							h = 0;
						s < c && (d = 1, h = 0), u < s && (h = 1, d = 0), !0 === n.crossable_handles && e.data("has_right_grip") && (S ? r <= i && r < o + a && (S = !1, o = r) : 0 <= o && r + a < o && (S = !0, r = o));
						var f = o,
							p = r;
						(0 < a && !d || a < 0 && !h) && (S ? f += a : p += a), T.validateAndMoveGripsToPx.call(e, f, p), g = s, "[object Touch]" !== Object.prototype.toString.apply(t) && t.preventDefault()
					}
				},
				...
				drag_end_func: function() {
					var t = w;
					if (void 0 !== t) {
						x = !1, g = void 0, T.notify_mouse_up_implicit.call(t, S), w = void 0;
						var e = t.data("settings");
						t.find(e.left_grip_selector + "," + e.value_bar_selector + "," + e.right_grip_selector).addClass(e.animating_css_class)
					}
				},
				get_rounding_for_value: function(t) {
					...
					if ("object" == typeof n) {
						var i = T.binarySearch.call(this, n, t, function(t, e) {
							return t[e].range
						}, function(t, e, n) {
							return t < e[n].range ? 0 < n ? t >= e[n - 1].range ? 0 : -1 : 0 : 1
						});
				...
				notify_mouse_up_implicit: function(t) {
					var e = this,
						...
						o = !1;
					return e.data("beforestart_min") === n && e.data("beforestart_max") === i || (o = !0, e.data("beforestart_min", n), e.data("beforestart_max", i)), e.data("settings").user_mouseup_callback.call(e, C.get_current_min_value.call(e), C.get_current_max_value.call(e), t, o), e
				},
				notify_changed_implicit: function(t, e, n) {
					...
					return i || (e = C.round_value_according_to_rounding.call(this, e), n = C.round_value_according_to_rounding.call(this, n)), !i && o === e && r === n || (T.notify_changed_explicit.call(this, t, e, n, o, r), i = 1), i
				},
				notify_changed_explicit: function(t, e, n, i, o) {
					var r = this.data("settings");
					return this.data("aria_enabled") && T.updateAriaAttributes.call(this), r.value_changed_callback.call(this, t, i, o, e, n), this
				},
			...
			C = {
				teardown: function() {
					return this.removeData(), _(document).unbind("mousemove.nstSlider").unbind("mouseup.nstSlider"), this.parent().unbind("mousedown.nstSlider").unbind("touchstart.nstSlider").unbind("touchmove.nstSlider").unbind("touchend.nstSlider"), this.unbind("keydown.nstSlider").unbind("keyup.nstSlider"), this
				},
				init: function(t) {
					var p = _.extend({
						...
						e = _(document);
					return e.unbind("mouseup.nstSlider"), e.unbind("mousemove.nstSlider"), e.bind("mousemove.nstSlider", T.drag_move_func), e.bind("mouseup.nstSlider", T.drag_end_func), this.each(function() {
						var o = _(this),
							t = o.parent();
						o.data("enabled", !0);
						var e = o.data("range_min"),
							...
							i = o.data("cur_min"),
							r = o.data("cur_max");
						void 0 === r && (r = i), "" === e && (e = 0), "" === n && (n = 0), "" === i && (i = 0), "" === r && (r = 0), o.data("range_min", e), o.data("range_max", n), o.data("cur_min", i), o.data("cur_max", r), T.validate_params.call(o, p), o.data("settings", p), void 0 !== p.rounding ? C.set_rounding.call(o, p.rounding) : void 0 !== o.data("rounding") ? C.set_rounding.call(o, o.data("rounding")) : C.set_rounding.call(o, 1);
						var s = o.find(p.left_grip_selector)[0],
							a = _(s),
							l = _(o.find(p.right_grip_selector)[0]);
						void 0 === a.attr("tabindex") && a.attr("tabindex", 0);
						var c = !1;
						0 < o.find(p.right_grip_selector).length && (c = !0, void 0 === l.attr("tabindex") && l.attr("tabindex", 0)), o.data("has_right_grip", c), !0 === o.data("aria_enabled") && (a.attr("role", "slider").attr("aria-disabled", "false"), c && l.attr("role", "slider").attr("aria-disabled", "false")), o.bind("keyup.nstSlider", function(t) {
							if (o.data("enabled")) {
								switch (t.which) {
									case 37:
									case 38:
									...
									case 40:
										if (m === y) {
											var e, n, i = T.getSliderWidthPx.call(o);
											if (v - b < 0) {
												for (e = b; e <= i; e++)
													if (C.round_value_according_to_rounding.call(o, T.getSliderValuesAtPositionPx.call(o, e, e)[1]) !== y) {
														n = e;
														break
													}
											} else
							...
							if (o.data("enabled")) {
								function e(t, e) {
									...
									switch (void 0 === m && (v = S ? n : i, m = S ? C.get_current_min_value.call(o) : C.get_current_max_value.call(o)), e.which) {
										case 37:
										case 40:
								...
								c && o.find(":focus").is(l) ? (S = !1, e.call(o, l, t)) : (S = !0, e.call(o, a, t))
							}
						});
						...
						e === n || i === r ? C.set_range.call(o, e, n) : T.set_position_from_val.call(o, o.data("cur_min"), o.data("cur_max")), T.notify_changed_implicit.call(o, "init"), o.data("beforestart_min", C.get_current_min_value.call(o)), o.data("beforestart_max", C.get_current_max_value.call(o)), o.bind("mousedown.nstSlider", function(t) {
				...
				get_current_min_value: function() {
					var t, e = _(this),
						...
						o = e.data("cur_min");
					if (t = o <= n ? n : C.round_value_according_to_rounding.call(e, o), T.haveLimits.call(e)) {
				...
				get_current_max_value: function() {
					var t, e = _(this),
						...
						i = C.get_range_max.call(e),
						o = e.data("cur_max");
					if (t = i <= o ? i : C.round_value_according_to_rounding.call(e, o), T.haveLimits.call(e)) {
						if (i <= t) return e.data("upper-limit");
						if (t <= n) return e.data("lower-limit")
					} else {
						if (i <= t) return i;
				...
				refresh: function() {
					...
					void 0 !== e && C.set_step_histogram.call(t, e), T.set_position_from_val.call(t, C.get_current_min_value.call(t), C.get_current_max_value.call(t));
				...
				disable: function() {
					var t = this.data("settings");
					return this.data("enabled", !1).find(t.left_grip_selector).attr("aria-disabled", "true").end().find(t.right_grip_selector).attr("aria-disabled", "true"), this
				},
				enable: function() {
					var t = this.data("settings");
					return this.data("enabled", !0).find(t.left_grip_selector).attr("aria-disabled", "false").end().find(t.right_grip_selector).attr("aria-disabled", "false"), this
				},
				is_enabled: function() {
				...
				set_position: function(t, e) {
					var n = this.data("cur_min"),
						i = this.data("cur_max");
					e < t ? T.set_position_from_val.call(this, e, t) : T.set_position_from_val.call(this, t, e), T.refresh_grips_style.call(this), T.notify_changed_implicit.call(this, "set_position", n, i), this.data("beforestart_min", t), this.data("beforestart_max", e)
				},
				set_step_histogram: function(t) {
					var n = this;
					n.data("last_step_histogram", t), void 0 === t && (_.error("got an undefined histogram in set_step_histogram"), T.unset_step_histogram.call(n));
					...
					if (!(e <= 0)) {
						...
						a.push(e);
						for (var c = [n.data("range_min")], u = 0, d = c[0], h = 0; u <= e;) {
						...
						return n.data("pixel_to_value_mapping", function(t) {
							return c[parseInt(t, 10)]
						}), n.data("value_to_pixel_mapping", function(t) {
							var e = T.binarySearch.call(n, c, t, function(t, e) {
								return t[e]
							}, T.binarySearchValueToPxCompareFunc);
							return c[e] === t ? e : Math.abs(c[e - 1] - t) < Math.abs(c[e] - t) ? e - 1 : e
						}), n
					}
				},
				...
				set_range: function(t, e) {
					...
					return this.data("range_min", t), this.data("range_max", e), T.set_position_from_val.call(this, n, i), T.notify_changed_implicit.call(this, "set_range", n, i), this
				},
				highlight_range: function(t, e) {
					var n = this.data("settings");
					void 0 === n.highlight && _.error('you cannot call highlight_range if you haven\' specified the "highlight" parameter in construction!'), t || (t = 0), e || (e = 0);
					...
					return r.css("left", i + "px"), r.css("width", o + "px"), this.data("highlightedRangeMin", t), this.data("highlightedRangeMax", e), T.refresh_grips_style.call(this), this
				},
				set_rounding: function(t) {
					"string" == typeof t && -1 < t.indexOf("{") && (t = _.parseJSON(t)), this.data("rounding", t);
					var e = [];
					if ("object" == typeof t) {
						var n;
						for (n in t)
		...
		_.fn.nstSlider = function(t) {
			if (C[t]) {
				if (!0 === this.data("initialized")) return C[t].apply(this, Array.prototype.slice.call(arguments, 1));
				throw new Error("method " + t + " called on an uninitialized instance of nstSlider")
			}
			return "object" != typeof t && t ? void _.error("Cannot call method " + t) : (this.data("initialized", !0), C.init.apply(this, arguments))
		}
	}(jQuery),
	function(r, d, h) {
		function f(t, e) {
		...
		function s(t) {
			...
			y._config.enableClasses && (0 < t.length && (e += " " + n + t.join(" " + n)), w ? _.className.baseVal = e : _.className = e)
		}

		function a(t, e) {
			if ("object" == typeof t)
				for (var n in t) S(t, n) && a(n, t[n]);
			else {
				var i = (t = t.toLowerCase()).split("."),
					o = y[i[0]];
				if (2 === i.length && (o = o[i[1]]), void 0 !== o) return y;
				e = "function" == typeof e ? e() : e, 1 === i.length ? y[i[0]] = e : (!y[i[0]] || y[i[0]] instanceof Boolean || (y[i[0]] = new Boolean(y[i[0]])), y[i[0]][i[1]] = e), s([(e && !1 !== e ? "" : "no-") + i.join("-")]), y._trigger(t, e)
			}
			return y
		}

		function p() {
			return "function" != typeof d.createElement ? d.createElement(arguments[0]) : w ? d.createElementNS.call(d, "http://www.w3.org/2000/svg", arguments[0]) : d.createElement.apply(d, arguments)
		}
		...
		function c(t, e, n, i) {
			...
			for (l = t.length, a = 0; a < l; a++)
				if (c = t[a], u = P.style[c], !~("" + c).indexOf("-") || (c = c.replace(/([a-z])-([a-z])/g, function(t, e, n) {
		...
		function i(t, e, n, i, o) {
			...
			return f(e, "string") || f(e, "undefined") ? c(s, e, i, o) : function(t, e, n) {
				var i;
				for (var o in t)
					if (t[o] in e) return !1 === n ? t[o] : f(i = e[t[o]], "function") ? u(i, n || e) : i;
				return !1
		...
		t._domPrefixes = x;
		var S, n, T = t._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
		t._prefixes = T, S = f(n = {}.hasOwnProperty, "undefined") || f(n.call, "undefined") ? function(t, e) {
		...
		var C, E = (C = !("onblur" in _), function(t, e) {
			var n;
			return !!t && (e && "string" != typeof e || (e = p(e || "div")), !(n = (t = "on" + t) in e) && C && (e.setAttribute || (e = p("div")), e.setAttribute(t, ""), n = "function" == typeof e[t], e[t] !== h && (e[t] = h), e.removeAttribute(t)), n)
		});
		t.hasEvent = E;
		var k, A = (k = r.matchMedia || r.msMatchMedia) ? function(t) {
			var e = k(t);
		...
		t.prefixedCSSValue = function(t, e) {
			...
			if (t in i) {
				var o = x.length;
				for (i[t] = e, n = i[t]; o-- && !n;) i[t] = "-" + x[o] + "-" + e, n = i[t]
			}
			return "" === n && (n = !1), n
		};
		...
		y._q.unshift(function() {
			delete P.style
		}), t.testAllProps = i, t.testAllProps = m, t.testProp = function(t, e, n) {
			return c([t], h, e, n)
			...
			var t = !1,
				e = x.length;
			for (t = y.hasEvent("pointerdown"); e-- && !t;) E(x[e] + "pointerdown") && (t = !0);
			return t
		});
		...
		y.addTest("postmessage", $), y.addTest("webgl", function() {
		...
		y.addTest("websockets", L), y.addTest("cssanimations", m("animationName", "a", !0)),
			function() {
				...
				for (var t, e, n = ["Width", "Span", "Fill", "Gap", "Rule", "RuleColor", "RuleStyle", "RuleWidth", "BreakBefore", "BreakAfter", "BreakInside"], i = 0; i < n.length; i++) t = n[i].toLowerCase(), e = m("column" + n[i]), "breakbefore" !== t && "breakafter" !== t && "breakinside" !== t || (e = e || m(n[i])), y.addTest("csscolumns." + t, e)
			}(), y.addTest("flexbox", m("flexBasis", "1px", !0)), y.addTest("picture", "HTMLPictureElement" in r), y.addAsyncTest(function() {
				var t, e, n = p("img"),
					i = "sizes" in n;
				!i && "srcset" in n ? (t = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", e = function() {
					a("sizes", 2 === n.width)
				}, n.onload = e, n.onerror = e, n.setAttribute("sizes", "9px"), n.srcset = t + " 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 8w", n.src = t) : a("sizes", i)
			...
			function() {
				...
				for (var s in v)
					if (v.hasOwnProperty(s)) {
						...
						for (i = f(e.fn, "function") ? e.fn() : e.fn, o = 0; o < t.length; o++) 1 === (r = t[o].split(".")).length ? y[r[0]] = i : (!y[r[0]] || y[r[0]] instanceof Boolean || (y[r[0]] = new Boolean(y[r[0]])), y[r[0]][r[1]] = i), b.push((i ? "" : "no-") + r.join("-"))
					}
	...
	function(t, e) {
		...
		$.Controller = function(t) {
			function e() {
				if (p && c) {
					...
					var e = u,
						n = (u = s.scrollPos()) - e;
					0 != n && (d = 0 < n ? "FORWARD" : "REVERSE"), "REVERSE" === d && t.reverse(), t.forEach(function(t) {
						t.update(!0)
					})
				}
			}
			...
			var i, o, r = x.defaults,
				...
				p = !0,
				g = function() {
					0 < a.refreshInterval && (o = window.setTimeout(_, a.refreshInterval))
				},
				m = function() {
					return a.vertical ? j.get.scrollTop(a.container) : j.get.scrollLeft(a.container)
				},
				v = function() {
					return a.vertical ? j.get.height(a.container) : j.get.width(a.container)
				},
				y = this._setScrollPos = function(t) {
					a.vertical ? h ? window.scrollTo(j.get.scrollLeft(), t) : a.container.scrollTop = t : h ? window.scrollTo(t, j.get.scrollTop()) : a.container.scrollLeft = t
				},
				b = function(t) {
					"resize" == t.type && (f = v(), d = "PAUSED"), !0 !== c && (c = !0, n())
				},
				_ = function() {
					if (!h && f != v()) {
						var e;
			...
			return this.addScene = function(t) {
					if (j.type.Array(t)) t.forEach(function(t) {
						s.addScene(t)
					});
					else if (t instanceof $.Scene)
						if (t.controller() !== s) t.addTo(s);
						else if (l.indexOf(t) < 0)
						for (var e in l.push(t), l = w(l), t.on("shift.controller_sort", function() {
								l = w(l)
					...
					if (j.type.Array(t)) t.forEach(function(t) {
						...
						var e = l.indexOf(t); - 1 < e && (t.off("shift.controller_sort"), l.splice(e, 1), t.remove())
					}
					return s
				}, this.updateScene = function(t, e) {
					return j.type.Array(t) ? t.forEach(function(t) {
						s.updateScene(t, e)
					}) : e ? t.update(!0) : !0 !== c && t instanceof $.Scene && (-1 == (c = c || []).indexOf(t) && c.push(t), c = w(c), n()), s
					...
					else if (t instanceof $.Scene) t.controller() === s && s.scrollTo(t.scrollOffset(), e);
					...
					return arguments.length ? (j.type.Function(t) && (m = t), s) : m.call(s)
					...
					return arguments.length ? (p != t && (p = !!t, s.updateScene(l, !0)), s) : p
				}, this.destroy = function(t) {
					window.clearTimeout(o);
					for (var e = l.length; e--;) l[e].destroy(t);
					return a.container.removeEventListener("resize", b), a.container.removeEventListener("scroll", b), j.cAF(i), null
				},
				function() {
					for (var t in a) r.hasOwnProperty(t) || delete a[t];
					if (a.container = j.get.elements(a.container)[0], !a.container) throw "ScrollMagic.Controller init failed.";
					(h = a.container === window || a.container === document.body || !document.body.contains(a.container)) && (a.container = window), f = v(), a.container.addEventListener("resize", b), a.container.addEventListener("scroll", b);
		...
		$.Controller.addOption = function(t, e) {
			...
			var e = this;
			$.Controller = function() {
				return e.apply(this, arguments), this.$super = j.extend({}, this), t.apply(this, arguments) || this
			}, j.extend($.Controller, e), $.Controller.prototype = e.prototype, $.Controller.prototype.constructor = $.Controller
		}, $.Scene = function(t) {
			var n, l, c = "BEFORE",
				u = "DURING",
				d = "AFTER",
			...
			this.on = function(t, o) {
				return j.type.Function(o) && (t = t.trim().split(" ")).forEach(function(t) {
					var e = t.split("."),
						n = e[0],
						i = e[1];
					"*" != n && (s[n] || (s[n] = []), s[n].push({
				...
				return t && (t = t.trim().split(" ")).forEach(function(t) {
					...
					("*" === n ? Object.keys(s) : [n]).forEach(function(t) {
						for (var e = s[t] || [], n = e.length; n--;) {
							var i = e[n];
							!i || o !== i.namespace && "*" !== o || r && r != i.callback || e.splice(n, 1)
						}
						e.length || delete s[t]
					})
				}), h
				...
				if (t) {
					...
					r && r.forEach(function(t) {
						o && o !== t.namespace || t.callback.call(h, new $.Event(i, t.namespace, h, e))
					})
				}
				return h
				...
				return t instanceof $.Controller && l != t && (l && l.removeScene(h), l = t, x(), r(!0), b(!0), e(), l.info("container").addEventListener("resize", _), t.addScene(h), h.trigger("add", {
					controller: l
				}), h.update()), h
			}, this.enabled = function(t) {
				...
				if (l)
					if (t)
						if (l.enabled() && o) {
							...
							e = 0 < f.duration ? (n - a.start) / (a.end - a.start) : n >= a.start ? 1 : 0, h.trigger("update", {
								startPos: a.start,
								endPos: a.end,
								scrollPos: n
							}), h.progress(e)
				...
				if (arguments.length) {
					var e = !1,
						...
						o = f.reverse || g <= t;
					if (0 === f.duration ? (e = g != t, p = 0 === (g = t < 1 && o ? 0 : 1) ? c : u) : t < 0 && p !== c && o ? (p = c, e = !(g = 0)) : 0 <= t && t < 1 && o ? (g = t, p = u, e = !0) : 1 <= t && p !== d ? (g = 1, p = d, e = !0) : p !== u || o || A(), e) {
						var r = {
								progress: g,
								state: p,
								scrollDirection: i
			...
			var v, y, e = function() {
				...
				b = function(t) {
					...
					if (l && (n || 0 < m)) {
						if (n)
							if (n.parentNode) {
								for (var i = l.info(), o = j.get.offset(i.container), r = i.vertical ? "top" : "left"; n.parentNode.hasAttribute(L);) n = n.parentNode;
								var s = j.get.offset(n);
								i.isDocument || (o[r] -= l.scrollPos()), e = s[r] - o[r]
							} else h.triggerElement(void 0);
						var a = e != m;
						m = e, a && !t && h.trigger("shift", {
				...
				w = j.extend(O.validate, {
					duration: function(e) {
						...
						if (e = parseFloat(e), !j.type.Number(e) || e < 0) throw n && (n = void 0), 0;
						return e
					}
				}),
				x = function(t) {
				...
				T = function(e) {
					h[e] || (h[e] = function(t) {
						return arguments.length ? ("duration" === e && (n = void 0), S(e, t) && (h.trigger("change", {
							what: e,
							newval: f[e]
						}), -1 < O.shifts.indexOf(e) && h.trigger("shift", {
							reason: e
						})), h) : f[e]
					})
				};
			this.controller = function() {
				...
				var t = f.offset;
				return l && (t += f.triggerElement ? m : l.info("size") * h.triggerHook()), t
			}, h.on("shift.internal", function(t) {
				var e = "duration" === t.reason;
				(p === d && e || p === u && 0 === f.duration) && A(), e && I()
			...
			function E() {
				l && v && p === u && ((y.relSize.width || y.relSize.autoFullWidth) && j.get.width(window) != j.get.width(y.spacer.parentNode) || y.relSize.height && j.get.height(window) != j.get.height(y.spacer.parentNode)) && I()
			}

			function k(t) {
				l && v && p === u && !l.info("isDocument") && (t.preventDefault(), l._setScrollPos(l.info("scrollPos") - ((t.wheelDelta || t[l.info("vertical") ? "wheelDeltaY" : "wheelDeltaX"]) / 3 || 30 * -t.detail)))
			}
			var A = function(t) {
					if (v && l) {
						var e = l.info(),
						...
						if (t || p !== u) {
							...
							y.pushFollowers ? 0 < f.duration && (p === d && 0 === parseFloat(j.css(y.spacer, "padding-top")) ? o = !0 : p === c && 0 === parseFloat(j.css(y.spacer, "padding-bottom")) && (o = !0)) : i[e.vertical ? "top" : "left"] = f.duration * g, j.css(n, i), o && I()
						} else {
							"fixed" != j.css(n, "position") && (j.css(n, {
								position: "fixed"
							}), I());
							var r = j.get.offset(y.spacer, !0),
								s = f.reverse || 0 === f.duration ? e.scrollPos - a.start : Math.round(g * f.duration * 10) / 10;
							r[e.vertical ? "top" : "left"] += s, j.css(y.spacer.firstChild, {
								top: r.top,
								left: r.left
							})
						}
				...
				I = function() {
					if (v && l && y.inFlow) {
						var t = p === u,
							...
							o = {};
						y.relSize.width || y.relSize.autoFullWidth ? t ? j.css(v, {
							width: j.get.width(y.spacer)
						}) : j.css(v, {
							width: "100%"
						}) : (o["min-width"] = j.get.width(e ? v : n, !0, !0), o.width = t ? o["min-width"] : "auto"), y.relSize.height ? t ? j.css(v, {
							height: j.get.height(y.spacer) - (y.pushFollowers ? f.duration : 0)
						}) : j.css(v, {
							height: "100%"
						}) : (o["min-height"] = j.get.height(e ? n : v, !0, !i), o.height = t ? o["min-height"] : "auto"), y.pushFollowers && (o["padding" + (e ? "Top" : "Left")] = f.duration * g, o["padding" + (e ? "Bottom" : "Right")] = f.duration * (1 - g)), j.css(y.spacer, o)
					}
				};
			this.setPin = function(t, e) {
				if (e = j.extend({}, {
					...
					}, e), !(t = j.get.elements(t)[0])) return h;
				...
				v.parentNode.style.display = n, !o && e.pushFollowers && (e.pushFollowers = !1);
				...
				if (o || j.extend(l, j.css(v, ["width", "height"])), j.css(a, l), a.setAttribute(L, ""), j.addClass(a, e.spacerClass), y = {
						spacer: a,
						relSize: {
							width: "%" === s.width.slice(-1),
							height: "%" === s.height.slice(-1),
							autoFullWidth: "auto" === s.width && o && j.isMarginCollapseType(r.display)
						},
				...
				return y.relSize.width && j.css(a, {
					...
					bottom: "auto",
					right: "auto"
				}), (y.relSize.width || y.relSize.autoFullWidth) && j.css(v, {
					boxSizing: "border-box",
					mozBoxSizing: "border-box",
					webkitBoxSizing: "border-box"
				}), window.addEventListener("scroll", C), window.addEventListener("resize", C), window.addEventListener("resize", E), v.addEventListener("mousewheel", k), v.addEventListener("DOMMouseScroll", k), A(), h
				...
				if (v) {
					if (p === u && A(!0), t || !l) {
						...
						y.spacer.parentNode.insertBefore(e, y.spacer), y.spacer.parentNode.removeChild(y.spacer), v.parentNode.hasAttribute(L) || (j.css(v, v.___origStyle), delete v.___origStyle)
					}
					window.removeEventListener("scroll", C), window.removeEventListener("resize", C), window.removeEventListener("resize", E), v.removeEventListener("mousewheel", k), v.removeEventListener("DOMMouseScroll", k), v = void 0
				}
				return h
			};
			var D, P = [];
			return h.on("destroy.internal", function(t) {
					...
					return 0 !== n.length && j.type.String(e) && (0 < P.length && h.removeClassToggle(), D = e, P = n, h.on("enter.internal_class leave.internal_class", function(t) {
					...
					return t && P.forEach(function(t) {
						j.removeClass(t, D)
					}), h.off("start.internal_class end.internal_class"), D = void 0, P = [], h
				},
				function() {
		...
		$.Scene.addOption = function(t, e, n, i) {
			...
			$.Scene = function() {
				return e.apply(this, arguments), this.$super = j.extend({}, this), t.apply(this, arguments) || this
			}, j.extend($.Scene, e), $.Scene.prototype = e.prototype, $.Scene.prototype.constructor = $.Scene
		...
		var j = $._util = function(s) {
			...
			function i(t, e, n, i) {
				...
				var o = (n ? e["offset" + t] || e["outer" + t] : e["client" + t] || e["inner" + t]) || 0;
				if (n && i) {
					var r = l(e);
					o += "Height" === t ? a(r.marginTop) + a(r.marginBottom) : a(r.marginLeft) + a(r.marginRight)
				}
				return o
			}
			...
			for (n = 0; !r && n < e.length; ++n) r = s[e[n] + "RequestAnimationFrame"], u = s[e[n] + "CancelAnimationFrame"] || s[e[n] + "CancelRequestAnimationFrame"];
			r || (r = function(t) {
